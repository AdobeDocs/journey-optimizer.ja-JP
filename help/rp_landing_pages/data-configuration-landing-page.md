...
title: データ設定
description: Journey Optimizerで調整されたキャンペーンを強化するために、リレーショナルスキーマ、データセット、ターゲティングディメンション、チャネル設定を設定する方法について説明します。
...
メールやその他のサポート対象チャネルを含む、オーケストレートキャンペーンで使用するチャネル設定をセットアップおよび設定する方法について説明します。
