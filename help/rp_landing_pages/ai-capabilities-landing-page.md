...
AI を活用したコンバージョンテクノロジーを使用して、静的画像デザインを編集可能なHTML メールテンプレートに変換します。

[Discover の画像をHTMLに変換](../using/email/image-to-html.md)
:::
...
自然言語クエリを使用して、ジャーニーに関する運用インサイトを AI Assistant で直接取得します。

[ジャーニーインサイトについて学ぶ](../using/start/ai-assistant.md)
:::
