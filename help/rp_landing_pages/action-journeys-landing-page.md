...
title: アクションの設定
description: API 呼び出し、応答、モニタリング、ガバナンスを介してジャーニーをサードパーティ製システムと接続するように、Journey Optimizerでカスタムアクションを設定する方法について説明します。
...
組み込みの監視およびレポート機能を使用して、ジャーニーでのカスタムアクションのパフォーマンスと実行を追跡します。
