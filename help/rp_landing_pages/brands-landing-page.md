...
title: ブランド
description: Journey Optimizerでブランドガイドラインを作成、管理、パーソナライズし、すべてのキャンペーンで一貫性のあるオンブランドコンテンツを提供する方法を説明します。
...
デフォルトのブランド環境設定を設定し、AI 生成コンテンツとシームレスに統合するためのブランドガイドラインを調整する方法について説明します。
...
一貫したコンテンツ生成のために、ブランドガイドラインに基づいてトレーニングされたカスタム生成 AI モデルを作成および管理する方法を説明します。
