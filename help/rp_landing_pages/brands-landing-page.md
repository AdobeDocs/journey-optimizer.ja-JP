...
title: ブランド
description: Journey Optimizer でブランドガイドラインを作成、管理、パーソナライズし、すべてのキャンペーンをまたいで一貫性のあるブランドに即したコンテンツを確保する方法について説明します。
...
AI 生成コンテンツとのシームレスな統合のために、デフォルトのブランド環境設定を指定し、ブランドガイドラインをカスタマイズする方法について説明します。
...
一貫性のあるコンテンツ生成のために、ブランドガイドラインに基づいてトレーニングされたカスタム生成 AI モデルを作成および管理する方法について説明します。

[生成モデルの管理](../using/content-management/generative-models.md)
:::
