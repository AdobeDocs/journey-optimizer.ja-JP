...
title: 意思決定管理レポートの作成
description: イベントデータセットと DecisioningEvents XDM スキーマを使用して意思決定管理レポートを作成し、オファーのパフォーマンスと決定結果を分析する方法を説明します。
...
意思決定管理イベントデータと DecisioningEvents XDM スキーマを使用して、Adobe Journey Optimizerでカスタムレポートを作成します。 この節では、イベントデータセットを使用する方法と、オファーの選択、フォールバックの使用状況、プレースメントの有効性を分析するために必要な XDM フィールドにアクセスする方法について説明します。
