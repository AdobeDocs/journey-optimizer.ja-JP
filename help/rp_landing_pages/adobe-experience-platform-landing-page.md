...
description: Journey Optimizer ジャーニー内で Adobe Experience Platform データおよびオーディエンス関数（inAudience 関数を含む）を使用する方法を説明します。
...
Adobe Experience Platform のプロファイル属性とデータセットにアクセスして使用し、メッセージやジャーニー条件をパーソナライズする方法をご確認ください。
...
ジャーニーの条件、アクション、式内で Adobe Experience Platform データを直接クエリおよび検索する方法について説明します。

[ジャーニーでの AEP データの使用](../using/data/lookup-aep-data.md)
:::
