...
特定のプロファイルを使用してテストし、イベント、条件、アクションが期待どおりに動作することを確認することで、公開前にジャーニーを検証できます。
...
ドライランを実行して、ジャーニーの実行パスをシミュレートおよび検証し、運用開始前に潜在的な問題を特定します。

[ジャーニードライランについて学ぶ](../using/building-journeys/journey-dry-run.md)
:::
...
[監視とトラブルシューティングを表示](troubleshoot-journey-landing-page.md)
:::
