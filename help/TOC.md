...
+ ジャーニー {#orchestrate-journeys}
   ...
   + {hide-from-toc}[ジャーニーの種類：適切なものを選ぶ](using/building-journeys/journey-types-selection.md)
   ...
   + アクティビティ {#about-journey-building}
      ...
      + 最適化 {#optimize-activity}
         + [最適化アクティビティの基本を学ぶ](using/building-journeys/optimize.md)
         + [パス実験](using/building-journeys/path-experimentation.md)
      ...
      + [ジャーニーフラグメント](using/building-journeys/journey-fragments.md)
   ...
   + 式の作成 {#building-advanced-conditions-journeys}
      ...
      + 構文 {#syntax}
         ...
         + {hide-from-toc}[例](using/building-journeys/expression/advanced-editor-use-cases.md)
   ...
   + ユースケース {#journey-use-cases}
      ...
      + [ジャーニーのエントリ条件と終了条件](using/building-journeys/entry-exit-criteria-guide.md)
      ...
      + {hide-from-toc}[配信を増やす](using/building-journeys/ramp-up-deliveries-uc.md)
...
+ ロイヤルティの課題 {#loyalty-challenges}
   ...
   + {hide-from-toc}[ロイヤルティの課題の API リファレンス](https://developer.adobe.com/journey-optimizer-apis/references/loyalty-challenges)
+ キャンペーン {#campaigns}
   ...
   + API トリガーキャンペーン {#api-triggered-campaigns}
      ...
      + [API トリガーキャンペーンの高スループットモードのアクティブ化](using/campaigns/api-triggered-high-throughput.md)
   + オーケストレーションキャンペーン {#orchestrated-campaigns}
      ...
      + データベースのクエリ {#query-database}
         ...
         + [定義済みフィルターの操作](using/orchestrated/predefined-filters.md)
      ...
      + 高度な操作 {#orchestrated-advanced}
         + [オーケストレーションキャンペーンでの変数の使用](using/orchestrated/variables-orchestrated-campaigns.md)
         + [オーケストレーションキャンペーンでのグローバル変数の定義](using/orchestrated/global-variables.md)
         + [シグナルを使用したオーケストレーションキャンペーンのトリガー](using/orchestrated/trigger-orchestrated-campaign.md)
...
+ 通信チャネル {#channels}
   ...
   + メールチャネル {#email}
      ...
      + メールコンテンツのデザイン {#design-email}
         + {hide-from-toc}[メールコンテンツのデザイン](/help/rp_landing_pages/design-email-landing-page.md)
         ...
         + コンテンツ作成を開始する {#start-creating-content}
            + {hide-from-toc}[コンテンツ作成の開始](/help/rp_landing_pages/start-creating-content-landing-page.md)
         ...
         + コンテンツの作成 {#add-content}
            + {hide-from-toc}[コンテンツのデザイン](/help/rp_landing_pages/add-content-landing-page.md)
            ...
            + [URL のパーソナライズ](using/email/url-personalization.md)
            + [パーソナライズされたオファーを挿入](using/email/add-offers-email.md)
            + [AI インボックス用のメールの最適化](using/email/llm-email-optimizer.md)
         ...
         + スタイルの編集 {#edit-style}
            + {hide-from-toc}[スタイルの編集](/help/rp_landing_pages/edit-style-landing-page.md)
   ...
   + SMS／MMS／RCS チャネル {#mobile}
      ...
      + [モバイルメッセージの確認および送信](using/mobile/send-mobile-message.md)
      ...
      + モバイルチャネルの設定 {#configure-mobile}
         ...
         + [インバウンドキーワードのカスタムデータセットの使用](using/mobile/custom-dataset-inbound-keywords.md)
   ...
   + インボックス {#inbox}
      + [インボックスの基本を学ぶ](using/inbox/inbox-gs.md)
      + [Journey Optimizer でのインボックスチャネルの設定](using/inbox/inbox-configuration.md)
      + [インボックスの作成](using/inbox/inbox-create.md)
      + [インボックスをデザイン](using/inbox/inbox-design.md)
   + WhatsApp {#whatsapp}
...
+ コンテンツ管理 {#content-management}
   ...
   + パーソナライゼーション {#personalization}
      ...
      + [トラッキングリンクの URL パラメーターの暗号化](using/personalization/url-parameter-encryption.md)
      + ヘルパー関数リスト {#functions}
         + [ヘルパー関数リスト](/help/rp_landing_pages/functions-landing-page.md)
         + [ヘルパー関数の基本を学ぶ](using/personalization/functions/functions.md)
         + {hide-from-toc}[外部データ参照ヘルパー](using/personalization/external-data-lookup.md)
      ...
      + パーソナライゼーションのユースケース {#personalization-use-cases}
         ...
         + [パーソナライゼーションのレシピ](using/personalization/personalization-recipes.md)
   ...
   + コンテンツテンプレート {#content-templates}
      ...
      + [メールテンプレートへの画像の変換](using/content-management/image-to-html.md)
   ...
   + クロスソリューションのユースケース {#combine}
      ...
      + 統合 {#integrations}
         ...
         + サンプルベンダー {#vendors}
            + [ベンダー統合の基本を学ぶ](using/integrations/vendor-integration-gs.md)
            + [サンプルベンダー設定](using/integrations/vendor-integration.md)
      + [MCP 経由での AI ツールの操作](/help/using/integrations/ajo-mcp.md)
...
+ 決定機能 {#decisioning}
   ...
   + 決定 {#experience-decisioning}
      ...
      + 決定への移行 {#migrate-to-decisioning}
         + [決定への移行のメリット](using/experience-decisioning/migrate-to-decisioning.md)
      ...
      + API リファレンス {#experience-decisioning-api-reference}
         + {hide-from-toc}[API リファレンス](/help/rp_landing_pages/experience-decisioning-api-reference-landing-page.md)
      ...
      + イベントデータの収集 {#experience-decisioning-collect-event-data}
         + {hide-from-toc}[データ収集の基本を学ぶ](using/experience-decisioning/data-collection/data-collection.md)
         + {hide-from-toc}[イベントを収集するデータセットの作成](using/experience-decisioning/data-collection/create-dataset.md)
...
+ チャネル設定 {#configuration}
   ...
   + {hide-from-toc}[AJO メッセージエクスポートスキーマ](using/configuration/message-export-schema.md)
   ...
   + メールサブドメインのデリゲート {#delegate-subdomains}
      ...
      + [CNAME からカスタムデリゲーションへの移行](using/configuration/custom-subdomain-migration.md)
   ...
   + IP ウォームアッププランの実装 {#implement-ip-warmup-plan}
      + [IP ウォームアッププランの基本を学ぶ](using/configuration/ip-warmup-gs.md)
      ...
      + {hide-from-toc}[IP ウォームアッププランのファイル](using/configuration/ip-warmup-plan-files.md)
   + メールアドレスの監視 {#monitor-reputation}
      + [メールアドレスの監視](/help/rp_landing_pages/monitor-reputation-landing-page.md)
      + {hide-from-toc}[メールのエラータイプ](using/configuration/email-error-types.md)
