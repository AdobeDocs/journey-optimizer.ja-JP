...
user-guide-description: Journey Optimizerを使用して、接続され、状況に応じた、パーソナライズされたエクスペリエンスを顧客に提供します
type: Documentation
...
+ メッセージ {#create-messages}
   ...
   + 電子メールデザイナー {#email-designer}
      + [電子メールデザインの基本を学ぶ](using/design-emails.md)
      + [UIでの電子メールコンテンツの設計](using/create-email-content.md)
      + [電子メールコンテンツをインポートまたはコーディング](using/existing-content.md)
      + [メールデザイナーの内容コンポーネントの使用](using/content-components.md)
   + パーソナライズ機能{#personalization}
      + [基本を学ぶ](using/personalization/personalize.md)
      + [パーソナライゼーション領域](using/personalization/personalization-aeras.md)
   ...
   + [パーソナライズオファーの追加](using/deliver-personalized-offers.md)
   + {#create-message}検証および公開
...
+ トラッキングと監視 {#reporting}
   ...
   + ライブレポート {#live-report}
      ...
      + [電子メールライブレポート](using/reports/email-live-report.md)
   ...
   + グローバルレポート {#global-report}
      ...
      + [グローバルレポートの E メール送信](using/reports/email-global-report.md)
      + [グローバルレポートをプッシュ](using/reports/push-global-report.md)
   + ジャーニーレポート {#reports}
...
+ 判定管理{#offer-decisioniong}
   ...
   + オファーの作成と管理 {#managing-offers-in-the-offer-library}
      ...
      + [ランク付け数式の作成](using/offers/offer-library/create-ranking-formulas.md)
   ...
   + 決定管理レポートの作成 {create-reports}
      ...
      + [Decision Management イベントの主な情報](using/offers/reports/key-information.md)
   ...
   + API リファレンス {#api-reference}
      + [基本を学ぶ](using/offers/api-reference/getting-started.md)
      ...
      + APIを使用した決定の作成と管理 {#activities-api}
   ...
   + ジャーニーの設定{#configure-journeys}
      ...
      + イベント設定 {#events-journeys}
         ...
         + 単一イベントの設定 {#unitary-events}
            ...
            + [Adobe Analytics を活用](using/event/about-analytics.md)
      ...
      + データソースの設定{#data-source-journeys}
         ...
         + [データソースを設定](using/datasource/configure-data-sources.md)
