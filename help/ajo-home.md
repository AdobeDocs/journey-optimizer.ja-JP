...
10月リリースが公開されました。これには、メールコンテンツのロック、Movable Ink との統合、ジャーニーでのコードベースおよび web エクスペリエンスが含まれます。以前は限定提供（LA）でしたが、メール設定のパーソナライゼーション、承認ポリシー、コンテンツの実験、レポートエクスペリエンスの向上、多言語コンテンツなど、すべてのユーザーが利用できる機能を追加しました。
