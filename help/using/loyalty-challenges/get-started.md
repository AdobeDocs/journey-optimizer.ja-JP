...
1. **コンテンツカードの設計** – お客様のデバイスに表示されるJourney Optimizer[&#x200B; コンテンツカード &#x200B;](../content-card/get-started-content-card.md) を使用して、課題を視覚的に表現します。 コンテンツカードには、チャレンジ情報、進行状況および報酬が表示されます。
