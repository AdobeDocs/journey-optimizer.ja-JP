...
>abstract="**購入**&#x200B;と&#x200B;**支出**&#x200B;の両方のアクティビティで、**[!UICONTROL 実施要件を満たす品目と除外品目]**&#x200B;属性を使用すると、実施要件を満たす品目とグループおよび除外する品目とグループを定義できます。 これにより、課題の目標に合わせて、特定の製品、カテゴリ、地域をターゲットにすることができます。 例えば、支出タスクを特定の製品カテゴリに限定することや、ギフトカードまたはプロモーション品目をタスク完了に向けてカウントから除外することができます。"
...
適格または除外するために項目IDを入力するだけでなく、**[!UICONTROL 独自のデータを取り込む]** オプションを使用して、実行時に外部ロイヤルティチャレンジのデータから適格性を促すこともできます。
