...
### 課題プロパティを定義し、カスタムメタデータを使用 {#properties}

>[!CONTEXTUALHELP]
>id="ajo_loyalty_challenge_properties"
>title="課題プロパティ"
>abstract="課題プロパティパネルで、課題名と説明を設定し、トラッキングや外部統合用のカスタムキーと値のメタデータを追加します。"
...
>title="課題スケジュール"
>abstract="スケジュールを使用すると、課題がライブになるタイミングを定義できます。顧客が課題を使用できるようになる開始日時と、完了の受付を停止する終了日時を設定します。 タイムゾーンを選択し、**[!UICONTROL 「タスク完了ウィンドウ」セクション]**&#x200B;で顧客がタスクを完了できるタイミングを選択します。"
...
## 課題オーディエンスを選択 {#audience}

>[!CONTEXTUALHELP]
>id="ajo_loyalty_challenge_audience"
>title="オーディエンス"
>abstract="「オーディエンス」タブで、使用可能な Adobe Experience Platform のオーディエンスから、課題に参加できるオーディエンスを選択します。"
