...
1. **エクスペリエンスのテスト**:[ テストプロファイル ](../content-management/test-profiles.md) を使用して、コンテンツカードの表示とタスクトリガーの動作を検証します。
...
1. [ ジャーニーをアクティベート ](../building-journeys/publish-journey.md) します。
