...
## リレーショナルデータベースのデータをメッセージのパーソナライゼーションに使用できますか？ {#relational-personalization}

はい。Campaign オーケストレーションでは、「人物エンティティ」と呼ばれる受信者プロファイルを更新でき、そのデータをパーソナライゼーションに使用できます。 また、リレーショナルデータベース内のリンクエンティティのエンリッチメントされたデータをパーソナライゼーションに使用することもできます。
