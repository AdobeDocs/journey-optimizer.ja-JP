...
オーケストレーションされたキャンペーンを作成して、**メール**、**SMS**、**プッシュ通知** および **ダイレクトメール** を送信できます。
...
はい、オーケストレーションキャンペーンは、クロスチャネルオーケストレーションをサポートしています。メール、SMS、プッシュ通知、ダイレクトメールの各アクティビティを複数の手順のキャンペーンキャンバスに組み合わせて、包括的な顧客体験を作成できます。
...
チャネルコンポーネントとランタイムはすべての Journey Optimizer キャンペーンに共通ですが、サポートされるチャネルは異なります。調整されたキャンペーンは、メール、SMS、プッシュ通知、ダイレクトメールをサポートします。
...
いいえ、web やアプリ内などのインバウンドチャネルは、オーケストレーションキャンペーンではサポートされていません。アウトバウンドチャネル（メール、SMS、プッシュ通知、ダイレクトメール）のみがサポートされます。
