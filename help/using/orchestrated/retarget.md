...
**[!UICONTROL オーケストレーションされたキャンペーン]**&#x200B;には、次の2つの主なスキーマが用意されています。
...
フィードバックベースのリターゲティングルールを使用すると、**[!UICONTROL メッセージフィードバック]** スキーマでキャプチャされたメッセージ配信イベントに基づいて受信者をリターゲティングできます。 これらのイベントには、メッセージの送信済み、開封済み、バウンス済み、スパムとしてマーク済みなどの結果が含まれます。

このデータを使用すると、以前にメッセージを受信した受信者を識別するルールを定義することで、特定の配信ステータスに基づいてフォローアップのコミュニケーションが可能になります。

1. 新しい&#x200B;**[!UICONTROL オーケストレーションされたキャンペーン]**&#x200B;を作成します。

1. **[!UICONTROL Build Audience]** アクティビティを追加し、ターゲティングディメンションを&#x200B;**[!UICONTROL 受信者（caas）]**&#x200B;に設定します。 「**[!UICONTROL 続行]**」をクリックします。

1. 素早く開始するには、組み込みの&#x200B;**[!UICONTROL キャンペーンフィードバック]** フィルターを使用して、メッセージ配信イベントに基づいて受信者をターゲットにすることができます。
   ...
   1. ![ フォルダーアイコン ](assets/do-not-localize/folder-search.svg)をクリックして、リターゲティングする特定のキャンペーンを選択します。 選択肢は次の2つです。
      ...
      * **[!UICONTROL 移行からのキャンペーン]**: オーケストレーションされたキャンペーンの以前のアクティビティからのキャンペーンを参照します。
...
トラッキングベースのリターゲティングルールは、**[!UICONTROL メールトラッキング]** スキーマのデータを使用して、メッセージとのやり取りに基づいて受信者をターゲットにします。 メールの開封数やリンクのクリック数など、ユーザーのアクションをキャプチャします。
...
1. 素早く開始するには、組み込みの&#x200B;**[!UICONTROL キャンペーンフィードバック]** フィルターを使用して、メッセージ配信イベントに基づいて受信者をターゲットにすることができます。
   ...
   1. フィルタールールを選択し、ターゲットにする&#x200B;**[!UICONTROL ビヘイビアー]**&#x200B;を選択します（**[!UICONTROL メッセージが開封されました]**、メッセージがクリックされた&#x200B;**[!UICONTROL など）。]**
