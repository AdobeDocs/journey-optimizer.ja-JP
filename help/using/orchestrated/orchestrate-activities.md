...
オーケストレーションキャンペーンキャンバスに追加できるアクティビティのリストが表示されます。 使用できるアクティビティは、オーケストレーションキャンペーンキャンバス内の位置によって異なります。 例えば、最初のアクティビティを追加する際に、オーディエンスを定義し（例：**オーディエンスを作成**、**オーディエンスを読み込む**、**ファイルを読み込む**）、オーケストレーションされたキャンペーンパスを分割するか、**待機** アクティビティを設定してオーケストレーションされたキャンペーンの実行を遅らせることができます。 一方、**オーディエンスを作成**&#x200B;アクティビティの後に、ターゲティングアクティビティでターゲットを絞り込んだり、チャネルアクティビティでオーディエンスに配信を送信したり、フロー制御アクティビティで調整されたキャンペーンプロセスを整理したりできます。
