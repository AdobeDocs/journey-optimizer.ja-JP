...
title: オーケストレーションされたキャンペーンでのグローバル変数の定義
description: オーケストレーションされたキャンペーンでグローバル変数を追加および管理する方法について説明します。
feature: Campaigns
...
**このページ：**&#x200B;では、オーケストレーションされたキャンペーンでグローバル変数を追加および管理する方法を説明します。これにより、ルールビルダー、テスト条件、その他のキャンバスロジックで共有名と値のペアを再利用できます。
...
1. **[!UICONTROL 保存]**&#x200B;の横にある&#x200B;**...** アイコンをクリックし、**[!UICONTROL 変数の編集]**&#x200B;を選択します。
   ...
   ![&#x200B; キャンペーンメニューの「変数を編集」オプション &#x200B;](assets/variables-list.png){zoomable="yes"}

1. 「**[!UICONTROL 変数を追加]**」をクリックし、変数の名前と値を設定します。 既存の変数を編集するには、**...** ボタンをクリックし、**[!UICONTROL 編集]**&#x200B;を選択します。

   変数を追加または編集する![変数パネル &#x200B;](assets/variables-edit.png){zoomable="yes"}
