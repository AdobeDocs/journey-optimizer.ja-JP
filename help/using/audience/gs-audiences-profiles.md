...
**プロファイル**
Adobe Journey Optimizerは、リアルタイムの顧客プロファイルを活用するための様々な機能を提供し、顧客の全体像を構築することができます。 &#x200B;の主な機能には、リアルタイムのデータ取り込み、ID グラフの作成、顧客エンゲージメントツールなどがあります。 ジャーニー、キャンペーン、または意思決定を通じてエンゲージされたプロファイルは、**エンゲージ可能なプロファイル**&#x200B;のライセンス指標にカウントされます。 [&#x200B; プロファイルの基本を学ぶ](get-started-profiles.md) | [&#x200B; ライセンス使用状況の監視](license-usage.md)

**オーディエンス**
Adobe Journey Optimizerには、マーケティング活動を強化するためのオーディエンスを作成、管理、強化するための強力なツールが備わっています。 &#x200B;主な機能は、ガバナンスツールやプライバシーツールとともに、オーディエンスのセグメンテーション、エンリッチメント、管理、アクティベーションです。 [オーディエンスの基本を学ぶ](about-audiences.md)
