...
**このページでは、** Adobe Journey Optimizerを他のAdobe ソリューションやサードパーティシステム（Customer Journey Analytics、Experience Manager、Stock、GenStudio、Campaign、Workfrontなど）と連携させる方法について説明します。
