...
キャッピングルールを設定する際に、Adobe Experience Platform データセットに保存されている属性を参照して、しきい値を定義できます。 データセットを使用するには、「**[!UICONTROL データセット]**」セクションで選択します。 [意思決定にAdobe Experience Platform データを使用する方法を学ぶ](../experience-decisioning/aep-data-exd.md)
