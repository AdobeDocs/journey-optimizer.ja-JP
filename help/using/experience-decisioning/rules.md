...
1. ルールエンティティを選択して、ルールを作成するオブジェクトのタイプを指定します。
   ...
   * **[!UICONTROL ターゲティング]** - ルールは、キャンペーンまたはジャーニーの[コンテンツ最適化](../campaigns/campaigns-message-optimization.md#targeting)の一部として、または[ジャーニーを最適化アクティビティ](../building-journeys/path-targeting.md)のいずれかで[ターゲティング](#targeting-rules)ルールを作成する際に使用できます。
