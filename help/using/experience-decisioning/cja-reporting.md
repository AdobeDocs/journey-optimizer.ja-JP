...
**このページ：**&#x200B;専用のDecisioning レポートにアクセスし、Customer Journey Analytics ダッシュボードを構築して、主要業績評価指標をモニターし、お客様が意思決定項目とどのように関わっているかを分析できます。

>[!ENDSHADEBOX]

## 決定レポート {#campaigns}

選択戦略を含むジャーニーやキャンペーンが公開されると、専用レポートにアクセスして、意思決定の主要業績評価指標（KPI）を監視できます。
