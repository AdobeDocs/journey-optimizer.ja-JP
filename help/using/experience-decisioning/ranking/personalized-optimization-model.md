...
**このページでは、** パーソナライズされた最適化モデルで、マシンラーニングを使用して、顧客、オファー、コンテキストデータ（ユースケース、アンサンブルモデルコンポーネント、データセット要件、仮定、コールドスタート動作など）から学習する方法を説明します。これにより、パーソナライズされたオファーを提供し、KPIを最大化するために、いつ使用するかを決定できます。
