...
* **オファーは十分に異なるため、ユーザーは検討中のオファー間で異なる好みを持つことになります**。オファーが類似しすぎている場合、応答がランダムに見えるため、結果のモデルの影響は少なくなります。
例えば、銀行が2つのクレジットカードのオファーを提供しており、色だけが異なる場合、どのカードが推奨されているかは関係ありませんが、各カードの条件が異なる場合、特定の顧客が1つを選択する理由を裏付け、より効果的なモデルを構築するためにオファー間で十分な違いを提供します。
