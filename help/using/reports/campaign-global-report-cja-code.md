...
キャンペーンから「**[!UICONTROL レポート]**」ボタンをクリックし、「**[!UICONTROL すべての時間レポートを表示]**」を選択すると、コードベースのキャンペーンレポートにアクセスできます。 [詳細情報](report-gs-cja.md)
...
* **ホールドアウト**：ユーザーには、AI モデルの有効性を測定するコントロール母集団として機能する、汎用バージョンのコンテンツが表示されます。
...
* **ホールドアウト**：ユーザーには、AI モデルの有効性を測定するコントロール母集団として機能する、コンテンツの汎用バージョンが表示されます。
