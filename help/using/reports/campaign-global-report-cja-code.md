...
Codeベースのキャンペーンレポートにアクセスするには、キャンペーンから [ **[!UICONTROL レポート]** ボタンをクリックし、[ **[!UICONTROL 表示全期間レポート]**] を選択します。 [詳細情報](report-gs-cja.md)
...
+++ 詳しくは、インプレッション数とクリック数の指標についての記事をご覧ください。
...
+++ 詳しくは、追跡リンクラベルの指標についての記事をご覧ください。
...
* **ホールドアウト**:ユーザーは、モデルの探索フェーズでランダムに提供される内容を受け取ります。
