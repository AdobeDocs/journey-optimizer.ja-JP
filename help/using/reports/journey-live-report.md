...
ジャーニーの { その他のアクション ] メニューを開き、「[!UICONTROL  過去 24 時間のレポートを表示 [!UICONTROL 」を選択して、[!UICONTROL ジャーニー] メニューからライブジャーニーレポートにアクセ ] します。
...
+++ 過去 24 時間に実行されたアクションの指標に関する詳細情報
...
+++ 詳しくは、メール – バウンスカテゴリと理由指標を参照してください
...
+++ 送信時間の最適化と、最適化指標と非最適化指標の詳細を説明します
...
+++ 詳しくは、SMS – 日付別パフォーマンス指標を参照してください
