...
**このページ：**&#x200B;訪問、コンバージョン、バウンス、訪問ソースなど、Adobe Journey Optimizer ライブレポートを使用して、過去24時間におけるランディングページのパフォーマンスをリアルタイムで測定します。
...
+++ランディングページのライブレポートで使用できる様々な指標およびウィジェットについて説明します。
