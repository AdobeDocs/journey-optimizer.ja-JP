...
>title="電子メール — 送信統計"
>abstract="「電子メール — 送信統計」テーブルは、ターゲットや配信済みなど、電子メールに関する重要なデータをまとめます。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_tracking_statistics"
>title="E メール — トラッキング統計"
>abstract="「電子メール — トラッキング統計」テーブルは、電子メールのプロファイルアクティビティに関するデータを提供します。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_sending_performance"
>title="電子メール — 送信パフォーマンス"
>abstract="E メール — 送信パフォーマンスグラフは、送信済み E メールに関する包括的なデータを表示し、配信やバウンスなどの主要指標に関するインサイトを提供し、E メール配信プロセスを詳細に分析できます。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_bounce_categories"
>title="電子メール — バウンスのカテゴリ"
>abstract="電子メール — バウンスカテゴリグラフと表は、一時的なエラーと永続的なエラーの両方に関するデータを提供します。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_bounce_reasons"
>title="電子メール — バウンス理由"
>abstract="E メール — バウンス理由のグラフと表には、バウンスメッセージに関連して使用できるデータが含まれています。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_error_reasons"
>title="電子メール — エラー理由"
>abstract="E メール — エラー理由グラフと表を使用して、送信プロセス中に発生した特定のエラーを特定できます。"
...
>title="電子メール — 上位の URL"
>abstract="電子メール — 上位の URL のグラフおよび表は、最も訪問者トラフィックが多い電子メール内の URL の包括的な概要を示し、最頻訪問リンクを特定できます。"

>[!CONTEXTUALHELP]
>id="ajo_campaign_global_email_best_recipient"
>title="E メール — 最適な受信者ドメイン"
>abstract="「 E メール — 最良の受信者ドメイン」グラフと表は、受信者が E メールを開くのに最も頻繁に使用するドメインの詳細な分類を示し、受信者の行動に関する貴重なインサイトを提供します。"
...
The **[!UICONTROL E メール送信統計]** グラフは、電子メールの成功の詳細を示します。

* **[!UICONTROL ターゲット]**：送信プロセス中に処理されたメッセージの合計数。

* **[!UICONTROL 送信済み]**：電子メールの送信の合計数。
...
* **[!UICONTROL エラー率]**：送信プロセス中に発生し、送信された E メールと比較して、送信を妨げたエラーの割合。

* **[!UICONTROL 再試行]**：再試行のキュー内のメール数。

* **[!UICONTROL 除外済み]**：Adobe Journey Optimizer によって除外されたプロファイルの数。

The **[!UICONTROL E メール — トラッキング統計]** ウィジェットには、電子メールのプロファイルアクティビティに使用できるデータが含まれます。
...
* **[!UICONTROL ユニーククリック率]**：電子メールでやり取りしたユーザーの割合。

* **[!UICONTROL 購読解除]** : 購読解除リンクのクリック数。

* **[!UICONTROL スパムのの苦情数]**：メッセージがスパムまたはジャンクとして宣言された回数。

The **[!UICONTROL 送信パフォーマンス]** グラフには、次のような送信済み E メールで使用できるデータが含まれます。
...
The **[!UICONTROL エラーの理由]** グラフとテーブルを使用すると、送信プロセス中に発生したエラーを確認できます。

この&#x200B;**[!UICONTROL 除外された理由]**&#x200B;グラフおよびテーブルには、ターゲットプロファイルから除外されたユーザープロファイルがメッセージを受信できなかった様々な理由が表示されます。

The **[!UICONTROL 電子メール — 上位の URL]** 電子メールからの URL のうち、最も訪問回数の多い URL のグラフおよびテーブルの詳細。
...
The **[!UICONTROL 送信時間の最適化]** 送信方法に応じて、電子メールの成功の詳細を示します（最適化、通常）。
...
>abstract="プッシュトラッキング統計は、プッシュ通知のプロファイルアクティビティに関するデータを提供します。"
...
>abstract="プラットフォームごとの分類のグラフと表は、プロファイルのオペレーティングシステムに基づいて、プッシュ通知の成功の内訳を示しています。"
...
* **[!UICONTROL エラー率]**：送信されたプッシュ通知と比較した、送信を防ぐ間に発生したエラーの割合。

* **[!UICONTROL 除外済み]**：Adobe Journey Optimizer によって除外されたプロファイルの数。

The **[!UICONTROL プッシュ — トラッキング統計]** には、プッシュ通知に使用できるプロファイルアクティビティのデータが含まれます。
...
The **[!UICONTROL 送信時間の最適化]** 送信方法に応じて、プッシュ通知の成功の詳細を示します（最適化、通常）。

* **[!UICONTROL 配信済み]**：送信されたメッセージの合計数に対して、正常に配達できたメッセージの数。

* **[!UICONTROL バウンス]**：送信メッセージの合計数に関する、送信プロセス中と自動返信処理中に累積したエラーの合計。

The **[!UICONTROL エラーの理由]** グラフと表を使用すると、発生したエラーを確認できます。

The **[!UICONTROL 除外された理由]** グラフと表には、ターゲットプロファイルから除外されたユーザープロファイルがメッセージを受信できなかった様々な理由が表示されます。

The **[!UICONTROL プラットフォーム別の分類]** プロファイルのオペレーティングシステムに応じて、プッシュ通知の成功の詳細をグラフおよび表で表示します。
+++
...
>title="SMS — エラー理由"
>abstract="「SMS - Error Reasons」グラフと表を使用して、送信プロセス中に発生した特定のエラーを特定できます。"
...
The **[!UICONTROL 理由を除外]** および **[!UICONTROL バウンス理由]** および **[!UICONTROL エラーの理由]** グラフと表を使用すると、送信プロセス中に発生したエラーと除外を確認できます。
...
>abstract="ダイレクトメール — エラー理由のグラフと表を使用して、送信プロセス中に発生した特定のエラーを特定できます。"
...
* **[!UICONTROL ターゲット]**：このダイレクトメールのターゲットプロファイルとして認定されるユーザープロファイルの数。

* **[!UICONTROL 送信済み]**：このダイレクトメールの送信総数。
