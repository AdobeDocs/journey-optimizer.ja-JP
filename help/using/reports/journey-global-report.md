...
**[!UICONTROL イベントのパフォーマンス]**&#x200B;および&#x200B;**[!UICONTROL 上位のイベント]**&#x200B;のウィジェットを使用すると、どの&#x200B;**[!UICONTROL イベント]**&#x200B;が正常に実行されたかをグラフや表を通して確認できます。
...
**[!UICONTROL エラー理由]**&#x200B;グラフは、**[!UICONTROL アクション]**&#x200B;で発生したエラーの種類の詳細を示します。
