...
フィードバック（迷惑メールの苦情、バウンスなど）を受け取らない場合 考慮に入れて、彼らはあなたの評判を下げるでしょう。 抑制リストは、ISP のフィードバックを尊重するのに役立ちます。
...
アドレスごとに、抑制される基本的な理由と抑制カテゴリ（ソフト、ハードなど） 抑制リストに表示されます。 抑制リストへのアクセスと管理について詳しくは、[この節](../configuration/manage-suppression-list.md)を参照してください。
