...
* すべて **ハードバウンス** および **スパム苦情** 1 回のオカレンスの後に、対応するアドレスを抑制リストに自動的に送信します。 スパムの苦情に関する詳細： [この節](#spam-complaints).
...
一部の ISP では、E メールを受信したユーザーがフィードバックループをスパムとしてマークした場合に、E メール送信者に自動的に通知を受け取るように、フィードバックループ (FBL) を提供しています。 [詳細情報](deliverability.md#feedback-loops)
