...
+++ 特定の期間における各エンドポイントの 1 秒あたりの成功した呼び出し、エラー、および要求の総数
...
+++ 特定の期間における各エンドポイントの成功した呼び出し、エラーおよびスループットの時系列
...
+++特定の期間における 50、95、99 および 99.9 百分位での各エンドポイントの応答遅延
...
+++特定の期間における各エンドポイントの応答の待ち時間のパーセンタイルの時系列
...
+++ 特定の期間における 50 番目および 95 番目のパーセンタイルのスロットルされたエンドポイントのキューでの待機時間
...
+++ スロットルされた各エンドポイントに対するキュー待機時間のパーセンタイルの時系列
...
+++ 特定の期間における特定のエンドポイントのタイプおよびコード別のエラー数
