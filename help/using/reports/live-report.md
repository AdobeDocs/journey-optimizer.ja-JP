...
**このページ：** Adobe Journey Optimizer ライブレポートを使用して、ジャーニーとキャンペーンのパフォーマンスをリアルタイムで視覚化し、ダッシュボードウィジェットをカスタマイズし、レポートを書き出します。
...
様々なレポートを PDF 形式または CSV 形式で簡単にエクスポートして、共有したり印刷したりできます。
...
1. 特定のウィジェットからデータをエクスポートすることもできます。 選択したウィジェットの横にある「**[!UICONTROL CSV ファイルをダウンロード]**」をクリックします。
