...
「**[!UICONTROL レポート]**」ボタンをクリックし、「**[!UICONTROL 過去 24 時間のレポートを表示]**」を選択すると、キャンペーンから直接ライブキャンペーンレポートにアクセスできます。
...
+++ 詳しくは、メール – 日付および理由指標によるパフォーマンスの指標を参照してください
...
+++ 詳しくは、プッシュ通知 – プラットフォーム指標による分類を参照してください
