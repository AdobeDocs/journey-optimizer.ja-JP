...
様々なレポートをPDF形式または CSV 形式で簡単に書き出し、共有または印刷できます。 レポートのエクスポート手順について詳しくは、次のタブを参照してください。
...
### レポートのエクスポート（ビデオ） {#video-csv}

レポートと単一のウィジェット用の CSV レポートをダウンロードする方法については、次のハウツービデオを参照してください。
