...
>title="購読ライブレポート"
>abstract="サブスクリプションライブレポートでは、過去 24 時間の購読者のアクティビティのみをリアルタイムで測定および視覚化できます。 レポートは、購読と購読解除を示す様々なウィジェットに分割されます。 各レポートダッシュボードは、ウィジェットをサイズ変更したり削除したりして変更できます。"

配信登録 **[!UICONTROL ライブレポート]** は、過去 24 時間の購読者のアクティビティに関する詳細のみを表示します。 選択した期間で購読を測定するには、[購読グローバルレポート](subscription-report-global.md)を参照してください。
