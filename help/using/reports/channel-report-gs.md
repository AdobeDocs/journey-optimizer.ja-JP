...
**このページでは、** カスタマイズ可能なチャネルレポートを使用して、キャンペーンとジャーニー全体のトラフィックとエンゲージメント指標を統合する方法を説明します。また、ダッシュボードウィジェットを管理し、レポートをPDFまたはCSVに書き出す方法を説明します。
