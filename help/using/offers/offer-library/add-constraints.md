...
>title="合計プロファイルの推定"
>abstract="セグメントまたは決定ルールを選択すると、推定認定プロファイルに関する情報を表示できます。 "
...
>title="キャッピング頻度の設定"
>abstract="オファーキャッピングカウンターを日単位、週単位、月単位でリセットするように選択できます。"
...
1. 保存され承認されると、定義した条件と期間に従って、このフィールドに指定した回数のオファーが提示された場合、その配信は停止されます。
