...
## AI モデルの基本を学ぶ {#get-started-with-ai-rankings}
...
* **マルチアームバンディット**：[マルチアームバンディット](https://en.wikipedia.org/wiki/Multi-armed_bandit){target=&quot;_blank&quot;}は、探索的学習とその学習の活用のバランスを最適化するためのアプローチです。
...
* [**ベータ分布**](https://ja.wikipedia.org/wiki/ベータ分布){target=&quot;_blank&quot;}：2 つの正の[形状母数](https://en.wikipedia.org/wiki/Shape_parameter){target=&quot;_blank&quot;}によって[パラメーター化](https://en.wikipedia.org/wiki/Statistical_parameter){target=&quot;_blank&quot;}された区間 [0, 1] で定義された連続[確率分布](https://ja.wikipedia.org/wiki/確率分布){target=&quot;_blank&quot;}のセットです。
