...
>[!NOTE]
>
>シミュレーションでは決定イベントが生成されないので、[キャップ](../offer-library/add-constraints.md#capping)カウントに影響はありません。
...
1. 使用可能な決定が表示されます。
   ...
   * 「**[!UICONTROL オファー決定を開く]**」リンクをクリックして、作成したすべての決定のリストを開きます。詳しくは、[決定](create-offer-activities.md)を参照してください。
