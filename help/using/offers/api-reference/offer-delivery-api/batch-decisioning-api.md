...
>[!NOTE]
>
>バッチ判定は、Journey Optimizerインターフェイスを使用して実行することもできます。 詳しくは、 [この節](../../batch-delivery.md)：グローバルな前提条件と、バッチ判定を使用する際に考慮すべき制限事項に関する情報を提供します。
...
1 つ以上の決定を準備するには、データセット、セグメント、決定が作成されていることを確認します。 これらの前提条件について詳しくは、 [この節](../../batch-delivery.md).
...
>[!NOTE]
>
>バッチジョブの処理時間に関する詳細については、 [この節](../../batch-delivery.md).
