...
に対してPOSTリクエストを実行することで、パーソナライズされたオファーを作成できます。 [!DNL Offer Library] API、コンテナ ID を提供している間。
...
正常な応答では、新たに作成されたパーソナライズされたオファーに関する情報（一意のインスタンス ID とプレースメントを含む）が返されます `@id`. 後の手順で、このインスタンス ID を使用して、パーソナライズされたオファーを更新または削除できます。
