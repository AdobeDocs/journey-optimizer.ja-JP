...
**このページ：** ラベルをマーケティング アクションにリンクするガバナンス ポリシーを作成して、機密データを保護し、そのラベルをジャーニー、キャンペーン、カスタム アクションに適用して、制限されたフィールドを外部で共有できないようにします。
...
ガバナンスポリシーを作成したら、マーケティングアクションをジャーニー/キャンペーンとジャーニーのカスタムアクションに適用できます。
[Journey Optimizerでマーケティング活動を適用する方法について説明します](#apply-marketing-actions)
