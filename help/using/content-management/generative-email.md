...
description: Journey Optimizerの AI Assistant コンテンツアクセラレーターを使用して、メールコンテンツとアセットの生成を開始
...
メールを作成およびカスタマイズした後、生成 AI を活用したJourney Optimizerの AI アシスタントコンテンツアクセラレーターの機能を活用して、コンテンツを高めます。

Journey Optimizerの AI Assistant コンテンツアクセラレーターを使用すると、完全なメール、カスタマイズされたテキストスニペット、オーディエンスに直接話しかけるカスタマイズされた画像を作成し、エンゲージメントとインタラクションを高めることで、キャンペーンの効果を高めることができます。
...
次の例では、AI アシスタント コンテンツ アクセラレータを利用して、既存の電子メール テンプレートを調整します。
...
次の例では、AI Assistant コンテンツアクセラレーターを活用して、メールのコンテンツを強化します
...
Journey Optimizerの AI Assistant コンテンツアクセラレーターを使用して、メール、テキスト、画像を生成する方法を説明します。
