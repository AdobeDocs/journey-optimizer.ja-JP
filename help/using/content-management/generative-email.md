...
1. 必要に応じてレイアウトをパーソナライズし、**[!UICONTROL AI アシスタント]**&#x200B;メニューにアクセスします。
   ...
   ![ブランド選択とプロンプトフィールドを示す E メールデザイナーの AI アシスタントパネル](assets/full-email-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![事前書き込み済みのプロンプト候補を表示する「プロンプトライブラリ」ボタンを含む「プロンプト」フィールド](assets/full-email-2.png){zoomable="yes"}
...
1. **[!UICONTROL ブランドアセット]**&#x200B;メニューから「**[!UICONTROL ブランドアセットをアップロード]**」をクリックすると、AI アシスタントに追加のコンテキストを提供できるコンテンツを含むブランドアセットを追加するか、以前にアップロードしたアセットを選択できます。
   ...
   ![「ブランドアセットをアップロード」ボタンと以前にアップロードしたアセットのリストを含む「ブランドアセット」セクション](assets/full-email-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![詳細な一致指標を含む割合スコアが表示されたブランド一致スコアパネル](assets/full-email-7.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンとコミュニケーション戦略ドロップダウンを含む「言い換え」と「よりシンプルな言葉を使用」オプションを表示する絞り込みメニュー](assets/full-email-5.png){zoomable="yes"}
...
1. 「**[!UICONTROL テキストコンポーネント]**」を選択して、特定のコンテンツのみをターゲットにします。次に、**[!UICONTROL AI アシスタント]**&#x200B;メニューにアクセスします。
   ...
   ![選択したテキストコンポーネントと右側のパネルで開かれた AI アシスタントメニューを含む E メールデザイナー](assets/text-genai-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![「プロンプト」フィールド、ブランドセレクター、プロンプトライブラリアクセスを含む AI アシスタントテキスト生成パネル](assets/text-genai-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **テキストの長さ**：スライダーを使用して、目的のテキストの長さを選択します。
   ...
   ![コミュニケーション戦略、言語、トーン、テキストの長さのスライダーコントロールを示す拡張されたテキスト設定](assets/text-genai-4.png){zoomable="yes"}

1. **[!UICONTROL ブランドアセット]**&#x200B;メニューから「**[!UICONTROL ブランドアセットをアップロード]**」をクリックすると、AI アシスタントに追加のコンテキストを提供できるコンテンツを含むブランドアセットを追加するか、以前にアップロードしたアセットを選択できます。

   以前にアップロードしたファイルは、**[!UICONTROL アップロードされたブランドアセット]**&#x200B;ドロップダウンで使用できます。生成に含めるアセットを切り替えるだけです。

   ![以前にアップロードしたブランドアセットの切替スイッチを表示するブランドアセットドロップダウンメニュー](assets/text-genai-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージインジケーターとプレビューコントロールが表示されている、生成されたテキストのバリエーション](assets/text-genai-6.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンドロップダウンを含む、「詳しく述べる」、「要約する」、「言い換え」、「よりシンプルな言葉を使用」の各ボタンを示す「絞り込み」オプションメニュー](assets/text-genai-5.png){zoomable="yes"}
...
1. 右側のメニューから、「**[!UICONTROL AI アシスタント]**」を選択します。
   ...
   ![画像アセットが選択され、画像生成用に開かれた AI アシスタントパネルを含む E メールデザイナー](assets/image-genai-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![参照スタイル切替スイッチ、ブランドセレクター、「プロンプト」フィールドを含む AI アシスタント画像生成パネル](assets/image-genai-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL 画像設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![縦横比、コンテンツタイプ、視覚的な強度、カラーとトーン、照明、構成の各コントロールを含む画像設定パネル](assets/image-genai-4.png){zoomable="yes"}
...
[Adobe Express 統合の詳細情報](../integrations/express.md)
   ...
   * 後でアクセスできるようにアセットを保存するには、「**[!UICONTROL 保存]**」を選択します。
   ...
   ![「類似を生成」ボタン、「Adobe Express で編集」ボタン、「保存」ボタンを示す生成された画像の「絞り込み」オプション](assets/image-genai-5.png){zoomable="yes"}
