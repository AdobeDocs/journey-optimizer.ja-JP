...
**このページ：** Adobe Journey OptimizerのAI アシスタントを使用して、コンテンツのバリエーションを生成し、ターゲットオーディエンス全体のパフォーマンスを測定する実験処理に変換する方法を説明します。
...
1. これで、コンテンツ実験から、コンテンツ実験の設定を開始できるようになりました。 [コンテンツ実験についての詳細情報](../content-management/content-experiment.md)
