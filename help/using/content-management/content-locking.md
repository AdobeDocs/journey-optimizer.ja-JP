...
>title="ガバナンス"
>abstract="ガバナンスをオンにして、テンプレート全体または特定の構造とコンポーネントをロックすることで、テンプレート内のコンテンツをロックします。 これにより、意図しない編集や削除を防ぎ、テンプレートのカスタマイズをより細かく制御して、メールキャンペーンの効率と信頼性を向上させることができます。"
...
>title="コンテンツ追加を有効にする"
>abstract="このオプションをオンにして、ユーザーによるテンプレートの操作方法をさらに定義します。 ユーザーが既存の構造間に構造を追加し、編集可能な構造内にコンテンツコンポーネントまたはフラグメントを追加できるようにするには、**構造とコンテンツの追加を許可** を選択します。 **コンテンツの追加のみを許可** 構造を追加または複製せずに、編集可能な構造内にコンテンツコンポーネントまたはフラグメントを追加できます。"
...
>title="構造でのコンテンツのロック"
>abstract="テンプレート内の構造をロックするには、「**ロックタイプ**」ドロップダウンから **ロック** を選択します。 デフォルトでは、ロックされた構造を削除することはできません。 この制限は、「**[!UICONTROL 削除を許可]** オプションを有効にすることで上書きできます。"
...
>abstract="テンプレート内のコンポーネントをロックするには、「**特定のロックを使用** オプションをオンにします。 **[!UICONTROL ロックタイプ]** ドロップダウンリストから、希望するロックオプションを選択します。**編集可能なコンテンツのロックのみ** を使用すると、コンポーネントのスタイルをロックできますが、コンテンツの編集は可能です。一方、**ロック** は、コンポーネントのコンテンツとスタイルの両方を完全にロックします。"
...
>abstract="テンプレートに適用されるロックのタイプに応じて、テンプレートの構造とコンポーネントに対して異なるアクションを実行できます。 テンプレート内のすべての編集可能な領域をすばやく識別するには、「編集可能な領域をハイライト **[!UICONTROL オプションをオンに切り替え]** す。"
