...
1. AI アシスタントにアクセス：
   * **プッシュ通知の場合**:**[!UICONTROL タイトル]** または **[!UICONTROL メッセージ]** フィールドの横にある「**[!UICONTROL AI アシスタントでテキストを編集]** メニューをクリックします。

     ![AI アシスタントでテキストを編集ボタンを使用したプッシュ通知作成画面 ](assets/push-genai-1.png){zoomable="yes"}

   * **SMS の場合**:**[!UICONTROL AI アシスタントを表示]** メニューにアクセスします。
...
1. AI アシスタントで **[!UICONTROL 参照コンテンツを使用]** （プッシュの場合）または **[!UICONTROL 元のコンテンツを使用]** （SMS の場合）オプションを有効にして、選択したコンテンツに基づいて新しいコンテンツをパーソナライズします。
...
1. プッシュの場合、生成するフィールド（タイトルまたはメッセージ）を選択します。
