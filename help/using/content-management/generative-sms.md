...
1. **[!UICONTROL AI アシスタントを表示]**&#x200B;メニューにアクセスします。
   ...
   ![ブランドセレクターと「プロンプト」フィールドを示す開かれた AI アシスタントパネルを含む SMS メッセージエディター](assets/sms-genai-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![ブランドセレクター、「プロンプト」フィールド、「プロンプトライブラリ」アクセスボタンを含む SMS の AI アシスタント](assets/sms-genai-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 長さ]**：範囲スライダーを使用して、コンテンツの長さを選択します。
   ...
   ![コミュニケーション戦略、言語、トーン、長さのスライダーコントロールを示す SMS のテキスト設定パネル](assets/sms-genai-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージインジケーターとプレビューオプションが表示されている、生成された SMS のバリエーション](assets/sms-genai-5.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスし、環境設定に合わせてバリエーションを微調整します。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンとコミュニケーション戦略ドロップダウンを含む「言い換え」、「よりシンプルな言葉を使用」を示す SMS の「絞り込み」オプション](assets/sms-genai-4.png){zoomable="yes"}
