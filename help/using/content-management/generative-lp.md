...
1. 必要に応じてレイアウトをパーソナライズし、**[!UICONTROL AI アシスタント]**&#x200B;メニューにアクセスします。
   ...
   ![完全なページコンテンツ生成用に開かれた AI アシスタントパネルを含むランディングページデザイナー](assets/lp-full-gen-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![完全なページ生成用の「プロンプト」フィールドとプロンプトライブラリアクセスを含むランディングページの AI アシスタント](assets/lp-full-gen-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL トーン]**：ランディングページのトーンは、オーディエンスの共感を呼ぶものにします。情報を提供する、遊び心を持たせる、説得力があるなど、目的に合わせて、AI アシスタントはメッセージを適切に調整することができます。
   ...
   ![「コミュニケーション戦略」オプション、「言語」オプション、「トーン」オプションを示すランディングページのテキスト設定パネル](assets/lp-full-gen-3.png){zoomable="yes"}
...
1. **[!UICONTROL 画像設定]**&#x200B;を選択します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![コンテンツタイプ、視覚的な強度、カラーとトーン、照明、構成を含むランディングページの画像設定パネル](assets/lp-full-gen-4.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアの割合インジケーターとプレビューコントロールを含む生成されたランディングページのバリエーション](assets/lp-full-gen-5.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンとコミュニケーション戦略ドロップダウンを含む「言い換え」、「よりシンプルな言葉を使用」を示すランディングページの絞り込みメニュー](assets/lp-full-gen-6.png){zoomable="yes"}
...
1. 「**[!UICONTROL テキストコンポーネント]**」を選択して、特定のコンテンツのみをターゲットにします。次に、**[!UICONTROL AI アシスタント]**&#x200B;メニューにアクセスします。
   ...
   ![テキストコンポーネントが選択され、テキスト生成用の AI アシスタントパネルを含むランディングページデザイナー](assets/lp-text-gen-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![「プロンプト」フィールドと「プロンプトライブラリ」ボタンを含むランディングページ用の AI アシスタントテキスト生成](assets/lp-text-gen-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **テキストの長さ**：スライダーを使用して、目的のテキストの長さを選択します。
   ...
   ![コミュニケーション戦略、言語、トーン、テキストの長さのスライダーを含むランディングページのテキスト設定](assets/lp-text-gen-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージと選択オプションが表示されている、生成されたランディングページのテキストバリエーション](assets/lp-text-gen-4.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンドロップダウンを含む、「詳しく述べる」、「要約する」、「言い換え」、「よりシンプルな言葉を使用」を示すランディングページのテキストの絞り込みメニュー](assets/lp-text-gen-5.png){zoomable="yes"}
...
1. 右側のメニューから、「**[!UICONTROL AI アシスタント]**」を選択します。
   ...
   ![画像アセットが選択され、画像生成用に開かれた AI アシスタントパネルを含むランディングページデザイナー](assets/lp-image-gen-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![参照スタイル切替スイッチ、「プロンプト」フィールド、プロンプトライブラリを含むランディングページ用の AI アシスタント画像生成](assets/lp-image-gen-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL 画像設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![縦横比、コンテンツタイプ、視覚的な強度、カラーとトーン、照明、構成を含むランディングページの画像設定](assets/lp-image-gen-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージとプレビューコントロールが表示されている、生成されたランディングページの画像バリエーション](assets/lp-image-gen-4.png){zoomable="yes"}
...
[Adobe Express 統合の詳細情報](../integrations/express.md)
   ...
   * 後でアクセスできるようにアセットを保存するには、「**[!UICONTROL 保存]**」を選択します。
   ...
   ![「類似を生成」ボタン、「Adobe Express で編集」ボタン、「保存」ボタンを示すランディングページ画像の「絞り込み」オプション](assets/lp-image-gen-5.png){zoomable="yes"}
