...
**このページ：**&#x200B;翻訳プロジェクトと言語設定を設定し、レビューと公開のためにキャンペーンまたはジャーニーのコンテンツを翻訳プロバイダーに送信して、自動翻訳を使用して多言語コンテンツを作成する方法を説明します。
...
1. 条件の作成を開始するには、属性、イベントまたはオーディエンスを追加してターゲットグループを定義します。
   ...
   1. **[!UICONTROL ルール]**&#x200B;メニューにアクセスし、新しいルールを作成します。 ルールの作成方法について詳しくは、[!DNL Adobe Experience Platform] [&#x200B; データ収集ドキュメント &#x200B;](https://experienceleague.adobe.com/en/docs/experience-platform/tags/ui/rules){target="_blank"}を参照してください
