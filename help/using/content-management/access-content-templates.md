...
コンテンツテンプレートにアクセスして管理するには、以下を確認します。

* **コンテンツテンプレート権限** – 役割に **[!UICONTROL コンテンツテンプレートの管理]** 権限（「**コンテンツ管理**」リソースの下）が含まれている必要があります。 この設定がない場合、左側のナビゲーションに **コンテンツテンプレート** メニューが表示されません。 [ 権限の管理方法については、こちらを参照してください ](../administration/permissions.md)
* **サンドボックス範囲** - コンテンツテンプレートは、サンドボックスに固有です。 あるサンドボックスで作成されたテンプレートは、別のサンドボックスでは使用できません。 テンプレートを検索する前に、正しいサンドボックスにいることを確認します。
* **HTML テンプレート（非推奨）** - 2025 年 3 月以降、HTML タイプのコンテンツテンプレートは非推奨（廃止予定）になります。 既存のHTML テンプレートには引き続きアクセスできますが、新しいテンプレートは作成できません。
...
+++左側のナビゲーションに「コンテンツテンプレート」メニューが表示されません

あなたの役割には **コンテンツテンプレートの管理** 権限がありません。 **コンテンツテンプレートの管理** 権限を持つ **コンテンツ管理** リソースを役割に追加するよう管理者に依頼します。 [詳細情報](../administration/permissions.md)

+++

+++作成したテンプレートがリストに表示されない

正しいサンドボックスに属していることを確認します。テンプレートは、サンドボックス固有です。 また、左側のペインでフォルダーが選択されているかどうかも確認します。フォルダーを選択すると、そのフォルダー内のテンプレートのみが表示されます。 フォルダーに関係なくすべてのテンプレートを表示するには、「**[!UICONTROL すべてのコンテンツテンプレート]**」をクリックします。

+++

+++テンプレートを編集したが、キャンペーンまたはジャーニーのコンテンツが更新されなかった

テンプレートを編集または削除しても、そのテンプレートを使用して作成されたキャンペーンやジャーニーが過去にさかのぼって更新されることはありません。 コンテンツは使用時にコピーされます。 既存のコンテンツを更新するには、キャンペーンまたはジャーニーを直接編集します。
