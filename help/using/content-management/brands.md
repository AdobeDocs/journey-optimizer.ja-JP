...
>title="ライティングスタイルのアラインメントスコア"
>abstract="ライティングスタイルセクションでは、明確で一貫性のあるコンテンツを保証するために、言語、書式設定、構造の標準を定義します。 アラインメントスコアは高から低の評価で、コンテンツがこれらのガイドラインにどれだけ準拠しているかを示し、改善が必要な領域を強調します。"
...
>abstract="ビジュアルコンテンツの整合性スコアは、コンテンツが設定済みのブランドガイドラインにどの程度適合しているかを示します。 ハイスコアからロースコアまで、一目でアラインメントを評価するのに役立ちます。 様々なカテゴリを調べて、改善点を特定し、ブランドに結びつかない可能性のある要素を特定します。"
