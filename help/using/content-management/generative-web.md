...
1. 「**[!UICONTROL テキストコンポーネント]**」を選択して、特定のコンテンツのみをターゲットにします。次に、**[!UICONTROL AI アシスタントを表示]**&#x200B;メニューにアクセスします。
   ...
   ![&#x200B; テキストコンポーネントが選択された Web デザイナーと「AI アシスタントを表示」メニューボタン &#x200B;](assets/web-gen-full-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![&#x200B; ブランドセレクター、プロンプトフィールド、プロンプトライブラリボタンを含む web ページテキストの AI アシスタントパネル &#x200B;](assets/web-gen-full-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **テキストの長さ**：スライダーを使用して、目的のテキストの長さを選択します。
   ...
   ![web コンテンツのコミュニケーション戦略、言語、トーンおよびテキスト長のスライダーを表示するテキスト設定パネル &#x200B;](assets/web-gen-full-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![&#x200B; ブランド調整スコアの割合インジケーターを使用した、生成された web ページのテキストのバリエーション &#x200B;](assets/web-gen-full-4.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![&#x200B; 精巧、要約、フレーズ変更、トーン ドロップダウン付きのよりシンプルな言語の使用を示す Web テキストの絞り込みメニュー &#x200B;](assets/web-gen-full-5.png){zoomable="yes"}
...
1. 右側のメニューから、「**[!UICONTROL AI アシスタントを表示]**」を選択します。
   ...
   ![&#x200B; 画像アセットが選択された Web デザイナーと、画像生成用に開かれた AI アシスタントのパネルを表示 &#x200B;](assets/web-gen-img-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![&#x200B; 参照スタイルの切り替え、ブランドセレクター、プロンプトフィールドを使用した、web 用 AI アシスタントの画像生成 &#x200B;](assets/web-gen-img-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL 画像設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![&#x200B; 縦横比、コンテンツタイプ、視覚強度、カラーとトーン、照明、コンポジションを使用した web の画像設定パネル &#x200B;](assets/web-gen-img-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![Brand Alignment Score およびプレビューコントロールを使用した、生成された web ページ画像のバリエーション &#x200B;](assets/web-gen-img-4.png){zoomable="yes"}
...
[Adobe Express 統合の詳細情報](../integrations/express.md)
   ...
   * 後でアクセスできるようにアセットを保存するには、「**[!UICONTROL 保存]**」を選択します。
   ...
   ![&#x200B; 「類似画像を生成」、「Adobe Expressで編集」および「保存」ボタンを表示する web 画像の絞り込みオプション &#x200B;](assets/web-gen-img-5.png){zoomable="yes"}
