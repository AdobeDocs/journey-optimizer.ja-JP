...
1. 「**[!UICONTROL テキストコンポーネント]**」を選択して、特定のコンテンツのみをターゲットにします。次に、**[!UICONTROL AI アシスタントを表示]**&#x200B;メニューにアクセスします。
   ...
   ![テキストコンポーネントが選択された web デザイナーと AI アシスタントを表示メニューボタン](assets/web-gen-full-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![ブランドセレクター、「プロンプト」フィールド、「プロンプトライブラリ」ボタンを含む web ページテキスト用の AI アシスタントパネル](assets/web-gen-full-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **テキストの長さ**：スライダーを使用して、目的のテキストの長さを選択します。
   ...
   ![Web コンテンツのコミュニケーション戦略、言語、トーン、テキストの長さのスライダーを示すテキスト設定パネル](assets/web-gen-full-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージインジケーターが表示されている、生成された web ページのテキストバリエーション](assets/web-gen-full-4.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンドロップダウンを含む、「詳しく述べる」、「要約する」、「言い換え」、「よりシンプルな言葉を使用」を示す web テキストの絞り込みメニュー](assets/web-gen-full-5.png){zoomable="yes"}
...
1. 右側のメニューから、「**[!UICONTROL AI アシスタントを表示]**」を選択します。
   ...
   ![画像アセットが選択され、画像生成用に開かれた AI アシスタントを表示パネルを含む web デザイナー](assets/web-gen-img-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![参照スタイル切替スイッチ、ブランドセレクター、「プロンプト」フィールドを含む web 用の AI アシスタント画像生成](assets/web-gen-img-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL 画像設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![縦横比、コンテンツタイプ、視覚的な強度、カラーとトーン、照明、構成を含む web 用の画像設定パネル](assets/web-gen-img-3.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアとプレビューコントロールを含む生成された web ページの画像バリエーション](assets/web-gen-img-4.png){zoomable="yes"}
...
[Adobe Express 統合の詳細情報](../integrations/express.md)
   ...
   * 後でアクセスできるようにアセットを保存するには、「**[!UICONTROL 保存]**」を選択します。
   ...
   ![「類似を生成」ボタン、「Adobe Express で編集」ボタン、「保存」ボタンを示す web 画像の「絞り込み」オプション](assets/web-gen-img-5.png){zoomable="yes"}
