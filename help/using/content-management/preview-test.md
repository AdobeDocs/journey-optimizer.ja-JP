...
また、特定の受信者や購読者にメールメッセージのテスト配信を送信してテストや検証を行い、一般的なデスクトップ、モバイル、web ベースのクライアントでレンダリングを確認することもできます。 さらに、読みやすさや有効性など、コンテンツ品質の一般的な側面を評価できます。 [&#x200B; コンテンツ品質検証の詳細情報 &#x200B;](brands-score.md#validate-quality)
