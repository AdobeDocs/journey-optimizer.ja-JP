...
**このページでは、** Adobe Journey OptimizerのA/B実験とマルチアームドバンディット実験を、それぞれの長所、制限事項、および各トラフィック割り当て方法が最も効果的なシナリオを含めて比較します。
