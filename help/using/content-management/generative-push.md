...
1. **[!UICONTROL AI アシスタントを表示]**&#x200B;メニューにアクセスします。
   ...
   ![ブランドとプロンプトのオプションを示す開かれた AI アシスタントパネルを含むプッシュ通知エディター](assets/push-genai-full-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![「プロンプト」フィールド、タイトルメッセージと画像のフィールドセレクター、プロンプトライブラリを含むプッシュ通知の AI アシスタント](assets/push-genai-full-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL トーン]**：プッシュ通知のトーンは、オーディエンスの共感を呼ぶものにします。情報を提供する、遊び心を持たせる、説得力があるなど、目的に合わせて、AI アシスタントはメッセージを適切に調整することができます。
   ...
   ![コミュニケーション戦略、言語、トーンドロップダウンを示すプッシュ通知のテキスト設定パネル](assets/push-genai-full-3.png){zoomable="yes"}
...
1. **[!UICONTROL 画像設定]**&#x200B;を選択します。
   ...
   * **[!UICONTROL 構成]**：画像のフレーム内の要素の配置を指します
   ...
   ![「コンテンツタイプ」、「視覚的な強度」、「カラーとトーン」、「照明」、「構成」の各オプションを含むプッシュ通知の画像設定](assets/push-genai-full-5.png){zoomable="yes"}
...
1. 「割合」アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアのパーセンテージとプレビューコントロールが表示されている、生成されたプッシュ通知バリエーション](assets/push-genai-full-4.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![言い換え、よりシンプルな言葉を使用、トーンとコミュニケーション戦略コントロールを含むプッシュ通知の「絞り込み」オプション](assets/push-genai-full-6.png){zoomable="yes"}
...
1. 「**[!UICONTROL タイトル]**」フィールドまたは「**[!UICONTROL メッセージ]**」フィールドの横にある **[!UICONTROL AI アシスタントでテキストを編集]**&#x200B;メニューにアクセスします。
   ...
   ![「タイトル」フィールドと「メッセージ」フィールドの横にある「AI アシスタントでテキストを編集」ボタンを含むプッシュ通知作成画面](assets/push-genai-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![参照コンテンツを使用切替スイッチ、ブランドセレクター、「プロンプト」フィールド、 「プロンプトライブラリ」ボタンを含む AI アシスタントテキストエディター](assets/push-genai-2.png){zoomable="yes"}
...
1. 次の&#x200B;**[!UICONTROL テキスト設定]**&#x200B;オプションを使用してプロンプトを調整します。
   ...
   * **[!UICONTROL 長さ]**：範囲スライダーを使用して、コンテンツの長さを選択します。
   ...
   ![コミュニケーション戦略、言語、トーンドロップダウン、長さのスライダーを示す拡張されたテキスト設定](assets/push-genai-4.png){zoomable="yes"}
...
1. 割合アイコンをクリックして、**[!UICONTROL ブランド一致スコア]**&#x200B;を表示し、ブランドとの不一致を特定します。
   ...
   ![ブランド一致スコアインジケーターが表示されている、プッシュ通知の生成されたテキストバリエーション](assets/push-genai-5.png){zoomable="yes"}
...
1. **[!UICONTROL プレビュー]**&#x200B;ウィンドウ内の「**[!UICONTROL 絞り込み]**」オプションに移動して、追加のカスタマイズ機能にアクセスします。
   ...
   * **[!UICONTROL よりシンプルな言葉を使用]**：AI アシスタントを活用して言葉を簡素化し、より幅広いオーディエンスに対して明確さとアクセシビリティを確保します。
   ...
   ![トーンドロップダウンを含む、「詳しく述べる」、「要約する」、「言い換え」、「よりシンプルな言葉を使用」の各オプションを示す絞り込みメニュー](assets/push-genai-6.png){zoomable="yes"}
...
1. **[!UICONTROL メディアを追加]**&#x200B;メニューにアクセスします。
   ...
   ![通知に画像を含める「メディアを追加」ボタンを備えたプッシュ通知エディター](assets/push-gen-img-1.png){zoomable="yes"}
...
1. 生成する内容を「**[!UICONTROL プロンプト]**」フィールドに記述して、コンテンツを微調整します。
   ...
   ![参照スタイル切替スイッチ、ブランドセレクター、「プロンプト」フィールドを含むプッシュ用の AI アシスタント画像生成](assets/push-gen-img.png){zoomable="yes"}
...
[Adobe Express 統合の詳細情報](../integrations/express.md)
   ...
   * 後でアクセスできるようにアセットを保存するには、「**[!UICONTROL 保存]**」を選択します。
   ...
   ![「類似を生成」ボタン、「Adobe Express で編集」ボタン、「保存」ボタンを示すプッシュ通知画像の「絞り込み」オプション](assets/push-gen-img-2.png){zoomable="yes"}
