...
* **データ選択のバッチ** - データセットからデータのバッチを削除すると、一致するすべてのキーがルックアップサービスから完全に削除されます。 例：

  **バッチ 1**:Sku1、Sku2、Sku3\
  **バッチ 2**:Sku1、Sku2、Sku3、Sku4、Sku5、Sku6\
  **バッチ 3**:Sku7、Sku8、Sku9、Sku10

  **バッチ 1** を削除すると、Sku1、Sku2、Sku3 がルックアップストアから削除されます。 結果のルックアップデータには、Sku4、Sku5、Sku6、Sku7、Sku8、Sku9、Sku10 が含まれます。
