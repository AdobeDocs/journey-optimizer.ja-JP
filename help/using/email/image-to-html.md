...
Image to HTML converter は、**コンテンツテンプレート** メニューで利用できる革新的な AI を活用した機能で、静的な画像デザインを完全にカスタマイズ可能なモジュール型のHTML メールコンテンツテンプレートに変換することで、メール作成を大幅に高速化します。 このノーコードツールを使用すると、マーケターは、技術的な専門知識がなくても、グラフィックデザイナーやデザインツールのビジュアルデザインを、レスポンシブで編集可能なメールテンプレートに変換できます。このテンプレートをコンテンツテンプレートライブラリに保存して、複数のジャーニーやキャンペーンで再利用できます。

>[!AVAILABILITY]
>
>この機能は、限定提供です。アクセス権を取得するには、アドビ担当者にお問い合わせください。

Image to HTML コンバーターは、ジェネレーティブ AI テクノロジーを活用して、画像内のレイアウト、タイポグラフィ、カラー、視覚要素を分析し、クリーンなモジュール型HTML コードを生成します。これにより、編集機能が完全に備わり、電子メールDesignerとの互換性が保たれます。 これにより、モックアップをHTMLに手動で変換する手間を省くことができ、開発担当者への依存度も低減します。

**主なメリット：**

* **HTMLへのデザインを数分で行える**:AI を活用したコードなしのコンバージョンにより、静的な画像を編集可能なモジュール型テンプレートに数分で変換し、テンプレートの作成時間を大幅に短縮します
* **技術者以外のユーザーをサポート**：設計チームや開発チームへの依存を減らします。マーケターは、最小限の技術知識でテンプレートを生成し、カスタマイズできます。
* **シンプルなプラットフォーム移行**：外部のテンプレートやデザインを他のプラットフォームからAJO対応のHTMLに簡単に変換できます
* **再利用可能なテンプレートライブラリの作成**：複数のジャーニーやキャンペーンで使用できる、スケーラブルでブランド一貫性のあるテンプレートライブラリを作成します
...
* **プラットフォームの移行**：別のメールマーケティングプラットフォームから移行しますか？ ゼロから再構築することなく、既存のメールデザインをAJO対応のHTML テンプレートに変換する
...
* **技術的依存関係の軽減**：マーケターがメールテンプレートを個別に作成し、繰り返すことができるため、キャンペーンの実行が迅速化されます
...
できます。画像からHTMLへのコンバーターは、他のメールマーケティングプラットフォームからの移行に最適です。 既存のメールデザインを以前のプラットフォームから書き出したりスクリーンショットを撮ったりして、最初から再構築することなく、AJO対応のHTML テンプレートに変換するだけです。
