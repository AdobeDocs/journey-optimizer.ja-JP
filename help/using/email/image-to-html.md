...
title: テンプレートアクセラレーターを使用して画像をHTML テンプレートに変換
description: AI を活用したテンプレートアクセラレーターを使用して、画像デザインを編集可能なHTML メールテンプレートに変換する方法を説明します
feature: Email Design
topic: Content Management
role: User
level: Beginner
keywords: メール，テンプレート，画像，HTML, AI, デザイン，アクセラレーター
hide: true
hidefromtoc: true
...
# テンプレートアクセラレーターを使用して画像をHTML テンプレートに変換 {#image-to-html}

>[!CONTEXTUALHELP]
>id="ajo_template_accelerator"
>title="テンプレート アクセラレータ"
>abstract="テンプレートアクセラレーターを使用して、静的画像デザイン（JPEGまたは PNG）を完全にカスタマイズ可能なHTML メールテンプレートに変換します。 この AI を活用した機能は、視覚的なデザインをレスポンシブで編集可能なメールコンテンツにすばやく変換するのに役立ちます。 注意：変換用の画像をアップロードすると、メール内の既存のコンテンツはすべて削除されます。"
...
テンプレートアクセラレーターは、革新的な AI を利用した機能で、**コンテンツテンプレート** メニューから利用できます。静的な画像デザインを完全にカスタマイズ可能なHTMLのメールコンテンツテンプレートに変換することで、メールの作成を大幅に高速化します。 このツールを使用すると、マーケターはグラフィックデザイナーやデザインツールのビジュアルデザインを、レスポンシブで編集可能なメールテンプレートに変換できます。このテンプレートをコンテンツテンプレートライブラリに保存して、複数のジャーニーやキャンペーンで再利用できます。

テンプレートアクセラレーターは、ジェネレーティブ AI テクノロジーを活用して、画像内のレイアウト、タイポグラフィ、カラー、視覚要素を分析し、クリーンで構造化されたHTML コードを生成します。このコードは、デザインの忠実性を維持しながら、電子メールDesignerとの完全な編集可能性と互換性を確保します。
...
テンプレートアクセラレーターを使用する前に、次のことを確認します。

* メールDesignerを使用したAdobe Journey Optimizerへのアクセス
* メールデザインを含むJPEGまたは PNG 形式の画像ファイル
* テンプレートアクセラレーター機能への限定提供アクセス（Adobe担当者にお問い合わせください）
...
1. テンプレートの詳細を入力し、チャネルとして **[!UICONTROL メール]** を選択します。

1. **[!UICONTROL 作成]** をクリックして、メールDesignerにアクセスします。

1. メールDesignerのホームページで、「**[!UICONTROL HTMLを読み込む]**」を選択します。

   ![](assets/import-html_2.png)

1. 読み込みダイアログには、**[!UICONTROL 画像をHTMLに変換]** セクションが表示されます。

   >[!CAUTION]
   >
   >変換用に画像をアップロードすると、**現在メールに追加されているすべてのコンテンツが削除され** 生成されたテンプレートに置き換えられます。 メールに既存のコンテンツがある場合は、必ず保存してから画像の変換を進めてください。

1. 「**[!UICONTROL 画像を読み込み]**」ボタンをクリックして、画像ファイルを選択します。

1. 画像ファイル（JPEGまたは PNG）をドラッグ&amp;ドロップするか、クリックして画像ファイルを参照して選択します。

1. 「**[!UICONTROL 生成]**」をクリックして、AI を利用した変換プロセスを開始します。

   >[!NOTE]
   >
   >生成プロセスには、画像デザインの複雑さとサイズに応じて最大 5 分かかる場合があります。 AI が画像を解析して変換する間、辛抱強くしてください。
...
テンプレートアクセラレーターを使用してコンテンツテンプレートを作成および保存したら、ジャーニーやキャンペーンでメールをデザインする際に使用できます。

1. ジャーニーまたはキャンペーンでメールを作成する際に、**[!UICONTROL コンテンツを編集]** 画面からメールDesignerにアクセスします。

1. メールDesignerのホームページで、「**[!UICONTROL 保存済みのテンプレート]**」タブに移動します。

1. リストからテンプレートアクセラレーターで生成されたテンプレートを選択します。

1. 「**[!UICONTROL このテンプレートを使用]**」をクリックして、メールに適用します。
...
テンプレートアクセラレーターの使用時に最適な結果を得るには、次の推奨事項に従います。

**事前準備**

* **既存のコンテンツを保存**：画像をHTMLに変換すると、メール内の既存のコンテンツがすべて置き換えられます。 この機能を使用する前に、必ず現在の作業を保存してください。
* **ワークフローの計画**：メール作成プロセスの開始時にテンプレートアクセラレーターを使用するか、現在のすべてのコンテンツを置き換える準備ができていることを確認します。
...
テンプレートアクセラレーターを使用する際は、次の制限事項に注意してください。
...
* **処理時間**：画像の複雑さとサイズによっては、変換プロセスに最大 5 分かかる場合があります。 変換が完了すると、テンプレートは自動的にドラフトとして保存されます。

* **限定提供**：限定提供機能として、テンプレートアクセラレーターは継続的に改善されています。 機能と精度は異なる場合があり、フィードバックは機能の強化に役立ちます。

>[!NOTE]
>
>テンプレートアクセラレーターは、メール作成の強力な出発点となるよう設計されています。 生成されたHTMLは、メールDesignerを使用して確認および調整し、正確な要件を満たしていることを確認する必要があります。

## よくある質問 {#faq}

+++テンプレートアクセラレーターを使用すると、既存のメールコンテンツはどうなりますか？

画像を変換用にアップロードすると、メール内の既存のコンテンツはすべて削除され、新しく生成されたテンプレートに置き換えられます。 この機能を使用する前に、重要なコンテンツを必ず保存してください。 テンプレートアクセラレーターは、メール作成プロセスの最初に使用することをお勧めします。

+++

+++サポートされているファイル形式は何ですか？

テンプレートアクセラレーターでは、JPEG（.jpg、.jpeg）および PNG （.png）の画像形式がサポートされます。

+++

+++変換プロセスにはどのくらいの時間がかかりますか？

変換には、画像デザインの複雑さとサイズに応じて、最大 5 分かかる場合があります。 変換が完了すると、ファイルは自動的にドラフトとして保存され、レビューして編集できます。
...
テンプレートアクセラレーターは現在、メールテンプレート専用に設計されています。 その他のコンテンツタイプの場合は、メールDesignerで使用可能な標準のデザインオプションと読み込みオプションを使用します。

+++

+++この機能を使用するには特別な権限が必要ですか？

テンプレートアクセラレーターは限定提供（LA）で利用できます。 この機能を使用するには、限定提供アクセス（アクセス権を取得するには、Adobe担当者にお問い合わせください）と標準のメールDesigner権限が必要です。

+++

+++コンバージョン済みのテンプレートを複数のキャンペーンで再利用できますか？

できます。テンプレート アクセラレータで作成されたテンプレートは、コンテンツ テンプレート ライブラリに自動的に保存されます。 ジャーニーやキャンペーンをまたいで、任意のメールでアクセスして再利用できます。 [詳細情報](../content-management/content-templates.md)
