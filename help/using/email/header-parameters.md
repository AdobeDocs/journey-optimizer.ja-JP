...
>[!IMPORTANT]
>
>**[!UICONTROL 送信者の名前]**&#x200B;と&#x200B;**[!UICONTROL 送信者の電子メール]**&#x200B;を一緒に設定する必要があります。両方のフィールドが入力されているか、両方とも空のままです。 そのうちの1つだけを入力すると、このチャネル設定でジャーニーとキャンペーンが公開されるのを防ぐことができます。

**Sender** ヘッダーを設定する場合は、次の点を考慮してください。

* **[!UICONTROL 送信者の名前]**&#x200B;と&#x200B;**[!UICONTROL 送信者の電子メール]** フィールドの両方を空のままにした場合、または解決済みの&#x200B;**送信者**&#x200B;が&#x200B;**送信者**&#x200B;と同じ場合、**送信者** ヘッダーは追加されません。
...
* **送信者** ヘッダーが設定されていて、パーソナライゼーションが受信者の値に解決されない場合、メッセージはその受信者に配信されません。
