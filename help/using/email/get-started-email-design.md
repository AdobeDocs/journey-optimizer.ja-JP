...
メールデザインのベストプラクティスについては、次の表を参照してください。

| 推奨 | 注意して使用 | 推奨しません |
|-|-|-|
| <ul><li>構造用 <b> 静的テーブルベースのレイアウト </b></li> <li><b>HTMLテーブルとネストされたテーブル </b> レイアウトを統一するため</li> <li><b> テンプレートの幅 </b> 600 ～ 800 ピクセル </li> <li>スタイル設定用の <b> シンプルなインライン CSS</b> </li> <li>ユニバーサル互換性のための <b>web セーフフォント </b></li> | <ul><li><b> 背景画像 </b> は、特定のメールプラットフォームでは表示されない場合があります。</li><li><b> カスタム web フォント </b> にはユニバーサルサポートがありません。</li><li><b> 幅の広いレイアウト </b> は、小さい画面には表示が悪い場合があります。</li><li><b> 画像マップ </b> には限られた機能があります。</li><li><b> 埋め込み CSS</b> は、メール配信中に削除される場合があります。</li> | <ul><li><b>JavaScript</b> は、通常、メール環境ではサポートされていません。</li> <li> ほとんどのプラットフォームでは、<b>`<iframe>`</b> 個のタグがブロックされています。 </li> <li><b>Flash</b> は古く、サポートされなくなりました。</li> <li><b> 埋め込みオーディオ </b> は、多くの場合、再生できません。</li> <li><b> 埋め込みビデオ </b> は、多くのメールプラットフォームと互換性がありません。</li> <li> <b>Forms</b> は、メール内では機能しません。</li> <li> レイ `<div>` リングを使用すると、レンダリングの問題が発生する場合があります。</li> |
