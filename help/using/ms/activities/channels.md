...
Adobe Journey Optimizerを使用すると、インバウンドチャネルとアウトバウンドチャネルをまたいでマーケティングキャンペーンを自動化および実行できます。 チャネルアクティビティを複数手順のキャンペーンキャンバスに組み合わせて、顧客の行動とデータに基づいてアクションをトリガーにできるクロスチャネルの複数手順のキャンペーンを作成できます。 サポートされているチャネルは [ このページ ](../../channels/gs-channels.md) に一覧表示されます。
