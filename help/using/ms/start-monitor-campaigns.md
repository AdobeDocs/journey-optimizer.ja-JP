...
>abstract="キャンペーン **スケジューラー** を使用すると、オーケストレーションされたキャンペーンを開始するタイミングをスケジュールできます。 このアクティビティはスケジュール済みの開始として考慮する必要があります。オーケストレーションされたキャンペーンの最初のアクティビティとしてのみ使用できます。"
...
## 調整されたキャンペーントランジション {#transitions}
