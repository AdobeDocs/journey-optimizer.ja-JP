...
[Adobe Experience Platformの FAQ とトラブルシューティングドキュメント ](https://experienceleague.adobe.com/en/docs/experience-platform/landing/troubleshooting){target="_blank"} も参照してください。
...
ジャーニーについては、次のトラブルシューティングの節を参照してください。
...
* [ ライブジャーニーの実行のトラブルシューティング ](../building-journeys/troubleshooting-execution.md)
