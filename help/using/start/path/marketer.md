...
1. **オーディエンスの作成**. Journey Optimizerでは、 **オーディエンス** メニューで使用し、ジャーニーで活用できます。  オーディエンスの詳細を表示 [このページ](../../audience/about-audiences.md). セグメント定義の作成方法の確認 [このサンプル](../../audience/creating-a-segment-definition.md).
