...
1. **オファーと決定を追加**&#x200B;します。AI を活用した決定を使用して、各顧客に最適なオファーを適切なタイミングで提供します。Decisioning を使用すると、プッシュ、SMS、その他のチャネルをパーソナライズできます。 [&#x200B; 意思決定管理 &#x200B;](../../offers/get-started/starting-offer-decisioning.md) および [&#x200B; 意思決定 &#x200B;](../../experience-decisioning/gs-experience-decisioning.md) について説明します。
