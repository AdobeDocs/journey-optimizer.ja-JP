...
1. **オファーと決定を追加**&#x200B;します。 AI を活用した決定を使用して、各顧客に最適なオファーを適切なタイミングで提供します。 決定機能を利用して、プッシュ通知や SMS などのチャネルをパーソナライズできます。 詳しくは、[意思決定管理](../../offers/get-started/starting-offer-decisioning.md)および[決定](../../experience-decisioning/gs-experience-decisioning.md)について説明します。
...
1. **カスタマージャーニーを作成**&#x200B;します。 ジャーニーキャンバスを使用して、リアルタイムでパーソナライズされたエクスペリエンスを作成します。 AI アシスタントの **Journey Agent** を使用して、自然言語プロンプトからジャーニーを作成します。 [Journey Agent の詳細情報](../ai-features.md#journey-agent)

   * **イベント**（顧客アクション）または&#x200B;**オーディエンス**（バッチ送信）でジャーニーをトリガーします。
   * **条件**&#x200B;を追加して、お客様データに基づいてパーソナライズされたパスを作成します
   * すべてのチャネルアクション（電子メール、プッシュ、SMS など）に対して、統合&#x200B;**アクションアクティビティ**&#x200B;を使用します。 [アクションアクティビティの詳細情報](../../building-journeys/journey-action.md)
   * **コンテンツ決定アクティビティ**&#x200B;を追加して、パーソナライズされたオファーをジャーニーフローに直接統合します。 [コンテンツ決定アクティビティの詳細情報](../../building-journeys/content-decision.md)
...
1. **監視および最適化**&#x200B;します。 パフォーマンスを追跡し、時間の経過と共に結果を改善します。
   ...
   * 競合管理ルールを使用して&#x200B;**メッセージの頻度と優先順位付け**&#x200B;を管理し、過剰なコミュニケーションを防ぎます。
   * 特定の期間に送信しないようにするには、**クワイエットアワー**（時間ベースの除外）を使用します。 [競合管理](../../conflict-prioritization/gs-conflict-prioritization.md)と[クワイエットアワーの詳細情報](../../conflict-prioritization/quiet-hours.md)
