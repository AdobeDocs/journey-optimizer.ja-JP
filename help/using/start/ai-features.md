...
* **完全なコンテンツ生成** - メール、web、ランディングページ、プッシュ用に、完全なコンテンツエクスペリエンス（テキストと画像）を 1 つのフローで生成します。 [AI アシスタントで完全なコンテンツを生成 &#x200B;](../content-management/generative-full-content.md)
...
* **具体的に** – 明確で詳細なプロンプトを表示して、より良い結果を得ます。 [&#x200B; 迅速なベストプラクティスを学ぶ &#x200B;](../content-management/ai-assistant-prompting-guide.md)
...
とAdobe GenStudio for Performance Marketingを統合して、AI を利用したメールコンテンツを作成し、オーケストレーション用にテンプレートをJourney Optimizerに読み込みます。 Journey Optimizer テンプレートをGenStudioに書き出し、AI を使用してバリエーションを生成し、デプロイメント用に戻します。 （限定提供、メールチャネルのみ）。

[GenStudioの詳細情報](../integrations/genstudio.md)
