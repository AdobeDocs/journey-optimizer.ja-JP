...
* ジャーニーアクティビティで使用されるタイムアウトのほかに、グローバルジャーニータイムアウトも存在します。こちらはインターフェイスに表示されず、変更もできません。 このグローバルタイムアウトは、ジャーニーにエントリした個人の 30 日後にジャーニーの進行状況を停止します。 [詳細情報](../building-journeys/journey-gs.md#global_timeout)
