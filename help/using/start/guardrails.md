...
**このページ：** Adobe Journey Optimizerのシステム、ジャーニー、オーディエンス、チャネル、コンテンツの制限を確認して、エラーを発生させることなく拡張するデプロイメントを計画できます。
...
* 一度にアクティブにできるライブ、クローズ、一時停止、ドライランのジャーニーの数は、実稼動サンドボックスでは&#x200B;**200**、開発サンドボックスでは&#x200B;**100**&#x200B;に制限されます。 この制限は、ジャーニーを公開するときに適用されます。 ジャーニーの現在の数は、ジャーニーキャンバスの上に表示されます。

  ジャーニーを公開すると、最大のスループットと安定性を確保するために自動的にスケールと調整が行われます。 クローズしたジャーニーは、このガードレールをロールアウトした後に作成された場合にのみカウントされます。

>[!NOTE]
>
>公開時のガードレールの場合、ガードレールが導入されたときに既に制限を超えている組織は例外を受け取ります。 既存のジャーニーには影響しません。
...
>[!TIP]
>
>**これが意味すること：** **50 アクティビティ制限**&#x200B;と&#x200B;**アクティブジャーニー制限**&#x200B;は、多くのチームが最初に拡大する際に直面する2つのガードレールです。 ジャーニーを早期に分割する計画を立て、サンドボックスのスループット競合を回避するために、「オーディエンスを読み取り」の開始時間を少なくとも5～10分間隔で広げます。
...
* 1つのイベントは、一度に最大&#x200B;**25**&#x200B;個のジャーニーで参照できます。 この制限に達すると、そのイベントを使用する追加のジャーニーの公開がブロックされます。
* 1つのXDM スキーマは、すべてのライブジャーニーとクローズジャーニーで一度に最大&#x200B;**100**&#x200B;件のイベントで参照できます。 この制限に達すると、そのスキーマを参照するイベントノードを含むジャーニーを公開します。
...
次のガードレールは、[Audience Qualification](../building-journeys/audience-qualification-events.md) ジャーニーアクティビティに適用されます。

* オーディエンスの選定アクティビティは、Adobe Campaign アクティビティと併用できません。
* オーディエンスの選定ジャーニーでは、補助識別子はサポートされていません。
* サンドボックスには、すべてのライブジャーニーとクローズドジャーニーに対して、最大&#x200B;**300**&#x200B;個のオーディエンス選定ノードを含めることができます。 この制限に達すると、追加のオーディエンス選定ノードを含むジャーニーの公開がブロックされます。
