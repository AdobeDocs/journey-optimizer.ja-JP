...
* v1 でジャーニーをイベントアクティビティで開始した場合、それ以降のバージョンをイベント以外で開始することはできません。ジャーニーを開始するには、 **オーディエンスの選定** イベント。
* で始まるジャーニー **オーディエンスの選定** v1 のアクティビティは、常に次の値で始まる必要があります **オーディエンスの選定** を参照してください。
...
* 増分読み取りでは、読み取りオーディエンスのジャーニーの新しいバージョンを作成できません。 ジャーニーを複製する必要があります。
...
* ビジネスイベントは、単一のイベントやオーディエンスの選定アクティビティと組み合わせて使用することはできません。
...
* Journey Optimizer でジャーニーをトリガーするには、イベントをデータ収集コアサービス（DCCS）にストリーミングする必要があります。バッチまたはイベントで内部 Journey Optimizer データセットから取り込まれたイベント（メッセージフィードバック、メールトラッキングログなど）ジャーニーのトリガーに使用できません。ストリーミングイベントを取得できないユースケースでは、これらのイベントに基づいてオーディエンスを作成し、 **オーディエンスの閲覧** アクティビティを使用します。 オーディエンスの選定は技術的に使用できますが、使用されるアクションに基づいて、下流の課題が生じる可能性があります。
...
* エクスペリエンスイベントフィールドグループは、オーディエンスの読み取り、オーディエンスの選定、ビジネスイベントアクティビティで始まるジャーニーでは使用できません。 新しいオーディエンスを作成し、ジャーニーでオーディエンス内条件を使用する必要があります。
