...
[オファー判定イベントデータセット](../start/datasets-query-examples.md#ode-decisionevents)
...
特定の電子メール ID が電子メールを受け取ったかどうか、受け取っていない場合はエラー、バウンスカテゴリ、コードは何でしたかを調べます。
...
## オファー判定イベントデータセット{#ode-decisionevents}
