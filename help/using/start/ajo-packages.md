...
**[キャンペーン](../campaigns/get-started-with-campaigns.md)**&#x200B;は、オーディエンスベースでマーケターが計画するものです。オーディエンスを定義し、メッセージを作成し、バッチ送信としてスケジュールまたはトリガー化します。 これらは、プロモーションのアウトリーチ、ニュースレター、マルチステップのオーディエンスワークフローに最適です。

**[ジャーニー](../building-journeys/journey-gs.md)**&#x200B;はリアルタイムでイベント主導であり、個々の顧客行動をリアルタイムで受け止め、顧客接点をまたいで1:1のエクスペリエンスを調整します。 オンボーディングフロー、購入後のシーケンス、リアルタイムのトリガーメッセージに最適です。
...
| ベースオファー | 最適な用途 | コア動作 |
|-----------|---------|--------------|
| **[Journey Optimizer - キャンペーン](../campaigns/get-started-with-campaigns.md)** | マーケターが計画したアウトリーチの一括送信 | オーディエンスベースのスケジュール済みオーケストレーション： バッチエンゲージメントとマーケターが計画したアウトリーチのための、単一またはマルチステップのキャンペーンワークフロー。 |
| **[Journey Optimizer - ジャーニー](../building-journeys/journey-gs.md)** | リアルタイムの顧客エンゲージメント | イベント駆動型、1:1 オーケストレーション。 リアルタイムのジャーニーとスケジュールされたジャーニーの両方に対応します。 |
...
| 機能 | 対象 | アドオンは必須です |
|-----------|-------------|----------------|
| [メール](../email/get-started-email.md) | すべての基本オファー | アウトバウンド配信 |
