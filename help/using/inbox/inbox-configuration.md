...
**このページ：**&#x200B;同意、オプションのアクセスラベル、およびインボックスがweb上またはiOSまたはAndroid アプリ上に表示される場所を設定するインボックス チャネル設定を定義します。これにより、インボックスを介してコンテンツ カード エクスペリエンスを配信できます。

>[!ENDSHADEBOX]

受信トレイを通じてコンテンツカードエクスペリエンスを配信する前に、**[!UICONTROL チャネル設定]**&#x200B;で&#x200B;**受信トレイ** チャネル設定を定義する必要があります。 この設定は、サーフェスを同意、オプションのアクセスラベル、およびエクスペリエンスがweb上またはiOSまたはAndroid アプリに表示される場所に関連付けます。 設定を作成するには、次の手順に従います。
