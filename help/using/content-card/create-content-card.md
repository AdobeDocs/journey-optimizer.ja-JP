...
>[!IMPORTANT]
>
>デフォルトでは、「閉じる」ボタンはカードを非表示にします。 さらに機能を追加するには、解雇または不適格ルールを手動で定義します。
...
1. 「**[!UICONTROL 追加の配信ルールを有効にする]**」オプションを有効にしてから、「**[!UICONTROL ルールを編集]**」を選択して、メッセージを表示、却下または永続的に非表示にするタイミングを定義します。
...
1. 「**[!UICONTROL 追加の配信ルールを有効にする]**」オプションを有効にしてから、「**[!UICONTROL ルールを編集]**」を選択して、メッセージを表示、却下または永続的に非表示にするタイミングを定義します。
   ...
   ルールビルダーを使用して、これらのアクションをトリガーにする特定の条件を設定します。
