...
条件付きルールは、パーソナライゼーションエディターを使用して作成し、コンテンツ間で再利用する場合に保存できます。 [ライブラリに条件付きルールを保存する方法を学ぶ](#save)
...
条件付きルールは、から作成します **[!UICONTROL 条件]** パーソナライゼーションエディター内のメニュー。このメニューには、次のいずれかの方法でアクセスできます。

* メール本文のコンポーネントに対して動的コンテンツを有効にする場合は、E メールデザイナーから。[メールに動的コンテンツを追加する方法を学ぶ](dynamic-content.md#emails)

  ![](assets/conditions-access-email.png)

* を使用してパーソナライゼーションを追加できる任意のフィールド [パーソナライゼーションエディター](personalization-build-expressions.md).
...
1. へのアクセス **[!UICONTROL 条件]** パーソナライゼーションエディターまたは電子メールデザイナーのメニューで、 **[!UICONTROL 新規作成]**.
