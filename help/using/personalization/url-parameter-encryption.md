...
# トラッキングでのURL パラメーターの暗号化 {#url-parameter-encryption}
...
* **マーケター**&#x200B;は、暗号化ヘルパーをパーソナライゼーションエディターに挿入し、保護する値とアクティブなキー識別子をレジストリから渡します。 構文とオプションについては、[URL パラメーターの暗号化](functions/helpers.md#url-parameter-encryption-helper)を参照してください。
