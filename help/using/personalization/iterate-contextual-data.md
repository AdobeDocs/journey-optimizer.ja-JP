...
カスタムアクション API 呼び出しから返された製品レコメンデーションを表示するには、以下の例を参照してください。
...
カスタムアクションから返されたネストされた配列（製品を含むカテゴリなど）を繰り返し処理するには、以下の例を参照してください。
...
データセットのルックアップ結果を繰り返し処理する際に、特定のカテゴリの製品のみをフィルタリングして表示するには、以下の例を参照してください。
