...
1. エントリイベント、および **プッシュ** アクションアクティビティ。

   ![](assets/perso-uc5.png)

1. プッシュ通知メッセージを設定およびデザインします。 この[節](../messages/get-started-content.md)を参照してください。

## 手順 2 - プロファイルでのパーソナライゼーションの追加 {#add-perso}

1. 内 **プッシュ** アクティビティ、クリック **コンテンツを編集**.
...
1. 内 **プッシュ** アクティビティ、クリック **コンテンツを編集** をクリックし、 **タイトル** フィールドに入力します。
