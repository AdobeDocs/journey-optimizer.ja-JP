...
| 意思決定管理 | **[!DNL Manage Experience decisioning]**：決定ポリシーやランタイムオプションなどのエクスペリエンス決定設定の読み取り、作成、編集、削除。</br>**[!DNL Manage decisions]**：決定エンティティの読み取り、作成、編集、削除。</br>**[!DNL Manage offers]**：すべてのオファー、コンポーネント、決定およびコレクションの読み取り、作成、編集、削除。</br>**[!DNL Manage ranking strategies]**：カスタムレポートの読み取り、作成、編集および削除、アクション機能の使用。</br>**[!DNL View Experience decisioning]**：エクスペリエンス決定設定への読み取り専用アクセス。 </br>**[!DNL View decisions]**：オファーエンティティへの読み取り専用アクセス。 |
...
| 実験アクセラレーター | **[!DNL Manage Experiment Metada]**：実験メタデータの読み取り、作成、編集、削除。</br>**[!DNL View Experiments]**：実験アクセラレーター内の実験への読み取り専用アクセス。 |
