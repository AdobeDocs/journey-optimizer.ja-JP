...
**このページ：**&#x200B;受信者がコミュニケーションの登録解除やパーソナライゼーションのオプトアウトを行う方法を管理します。これにより、受信者の同意選択を尊重し、法的義務およびブランドの評判に関する義務を満たすことができます。
...
<div>
<a href="../mobile/mobile-opt-out.md"><strong>SMS オプトアウトの管理</strong></a>
</div>
<p></td>
</tr></table>
