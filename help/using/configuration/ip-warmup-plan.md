...
1. から **[!UICONTROL IP ウォームアップ設定]** リソース ドロップダウンで、ユーザーに必要な権限を選択します。 **[!UICONTROL IP ウォームアッププランを表示]**, **[!UICONTROL IP ウォームアッププランの管理]**、および/または **[!UICONTROL IP ウォームアップレポートの表示]**. 必要に応じて、すべてを一度に選択できます。
