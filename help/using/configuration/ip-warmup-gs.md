...
* [Adobe Journey Optimizer配信品質ガイド：評価ゼロからインボックスヒーローまで &#x200B;](https://experienceleaguecommunities.adobe.com/t5/journey-optimizer-blogs/adobe-journey-optimizer-deliverability-guide-from-zero/ba-p/761950?profile.language=ja) – 評価の基礎、ウォームアップカレンダー、監視、トラブルシューティングのベストプラクティスを含む包括的なガイドです。
