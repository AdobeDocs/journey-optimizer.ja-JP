...
>[!NOTE]
>
>このサブセクションのキャンペーンサンドボックスコピー情報は、**アクション**&#x200B;のキャンペーンと&#x200B;**API トリガー**&#x200B;のキャンペーンに適用されます。 **オーケストレーションされた** キャンペーンは、サンドボックス間のコピーではサポートされていません。

**アクション**&#x200B;および&#x200B;**API トリガー**&#x200B;のキャンペーンの場合、キャンペーンは、プロファイル、オーディエンス、スキーマ、インラインメッセージ、依存オブジェクトに関連するすべての項目と共にコピーされます。 ただし、次の項目はコピーされ&#x200B;**ません**。
