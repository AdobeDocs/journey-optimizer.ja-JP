...
* ランディングページは、現在、サンドボックス間の移行ではサポートされていません。 ジャーニーを別のサンドボックスにコピーした場合、ジャーニーまたはメールコンテンツのランディングページへの参照は、引き続き元の（ソースの）サンドボックスランディングページ ID を指します。 移行後、ターゲット（宛先）サンドボックスの正しいランディングページ ID を使用するために、ジャーニーとメールコンテンツのすべてのランディングページ参照を手動で更新する必要があります。 [ ランディングページの作成と公開 ](../landing-pages/create-lp.md) を参照してください。
