...
1. メッセージインターフェイスまたは電子メールデザイナーで「**[!UICONTROL コンテンツをシミュレート]**」ボタンをクリックして、テストプロファイルの選択にアクセスします。
...
1. テストプロファイルを識別する値を入力し、「**[!UICONTROL プロファイルを追加]**」をクリックします。
...
メールコンテンツをプレビューするには、次の手順に従います。

1. メールコンテンツの上にある「**[!UICONTROL コンテンツをシミュレート]**」ボタンをクリックします。
...
1. プッシュコンテンツの上にある「**[!UICONTROL コンテンツをシミュレート]**」ボタンをクリックします。

1. テストプロファイルを選択します。列内で利用可能な値を確認できます。右向きや左向きの矢印を使用して、データを参照します。

1. **[!UICONTROL プッシュ]**&#x200B;メッセージに切り替えます。
...
複数のインボックスにわたってメールのレンダリングをテストする方法、パーソナライズされたメールをテストプロファイルに照らしてプレビューする方法および配達確認を送信する方法を説明します。
