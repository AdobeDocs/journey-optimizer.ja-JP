...
>title="プロファイルごとのユニーククリック数"
>abstract="プロファイルごとのユニーククリック数指標は、実験によってオーディエンスが魅力的になり、ターゲットとする宛先へのクリック数を増やす効果的な効果を把握するのに役立ちます。 特定のリンクでのユニーククリック数を、リンクに公開されたプロファイルの総数で割って計算します。"
