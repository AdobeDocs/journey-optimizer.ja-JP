...
真のビジネスインサイトを得るには、1 つの実験に集中する必要があります。代わりに、新しい仮説を作成し、異なる変更を加えた新しいテストを実行し、異なるオーディエンスに対して、異なる指標に与える影響を調べて、実験を続行します。
+++
...
* **より深く掘り下げた分析**
  ...
  あるオーディエンスに対して正常に動作した処理であっても、別のオーディエンスに対しては最適な処理ではない場合があります。様々なオーディエンスに対する処理の動作に関する詳細な分析をおこなうことで、新しいテストのアイデアを生み出すのに役立ちます。
