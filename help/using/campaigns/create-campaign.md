...
新しいキャンペーンを作成するには、 **[!UICONTROL キャンペーン]** メニュー、次に「 **[!UICONTROL キャンペーンを作成]**. また、既存のライブキャンペーンを複製して新しいキャンペーンを作成することもできます。[詳細情報](modify-stop-campaign.md#duplicate)
...
>title="キャンペーンカテゴリ"
>abstract="カテゴリの値は、キャンペーンタイプの値に直接関連付けられます。 次のキャンペーンタイプをスケジュール **マーケティング** カテゴリのカテゴリおよび API トリガータイプ **トランザクション**"

1. 内 **[!UICONTROL プロパティ]** 「 」セクションで、キャンペーンの実行方法を指定します。 次の 2 種類のキャンペーンを使用できます。
...
1. 内 **[!UICONTROL アクション]** 「 」セクションで、メッセージの送信に使用するチャネルとチャネルサーフェスを選択します。
...
1. クリック **[!UICONTROL 作成]** をクリックして、キャンペーンを作成します。

## キャンペーンのプロパティを定義する {#create}
...
有効化直後にキャンペーンを実行しない場合は、 **[!UICONTROL キャンペーン開始]** オプション。 「**[!UICONTROL キャンペーン終了]**」オプションを使用すると、繰り返しキャンペーンの実行を停止するタイミングを指定できます。
