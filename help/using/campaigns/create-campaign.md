...
>title="キャンペーンのタイプ"
>abstract="**予定キャンペーン** は、指定した日付に即座に実行され、マーケティングタイプのメッセージを送信するために使用されます。 **API トリガー** キャンペーンは、API 呼び出しを使用して実行されます。 マーケティングメッセージとトランザクションメッセージのどちらかを送信することを目的としています。つまり、個人が実行したアクションに従って送信されるメッセージを対象としています。パスワードのリセット、買い物かごの放棄など"

>[!CONTEXTUALHELP]
>id="ajo_campaigns_campaign_category"
>title="キャンペーンカテゴリ"
>abstract="スケジュールされたキャンペーンを作成している場合、 **マーケティング** 「タイプ」は自動的に選択されます。 API トリガーキャンペーンの場合、 **マーケティング** または **トランザクション** メッセージとは、個人が実行したアクションの後に送信されたメッセージです。パスワードのリセット、買い物かごの放棄など"

1. 「**[!UICONTROL プロパティ]**」セクションで、キャンペーンを実行する方法を指定します。次の 2 種類のキャンペーンを使用できます。

   * **[!UICONTROL スケジュール型]**：キャンペーンをすぐに実行するか、指定日に実行します。スケジュールされたキャンペーンの対象は送信です。 **マーケティング** メッセージ。 これらはユーザーインターフェイスから設定および実行されます。

   * **[!UICONTROL API トリガー]**：API 呼び出しを使用してキャンペーンを実行します。API トリガーキャンペーンは、次のいずれかを送信することを目的としています。 **マーケティング**&#x200B;または **トランザクション** メッセージとは、個人が実行したアクションの後に送信されたメッセージのことです。パスワードのリセット、買い物かごの購入など [API を使用してキャンペーンをトリガーする方法についてはこちらを参照してください](api-triggered-campaigns.md)

1. スケジュールされたキャンペーンを作成している場合、 **マーケティング** 「タイプ」は自動的に選択されます。 API トリガーキャンペーンの場合、 **マーケティング** または **トランザクション** メッセージ」
