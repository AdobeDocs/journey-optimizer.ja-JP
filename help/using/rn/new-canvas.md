...
ただし、次のような場合： **新しいジャーニーの作成** または **既存のものを複製**&#x200B;新しいモデルジャーニーになります。 従来のモデルのジャーニーは、大部分のお客様が新しいモデルに移行されるまで、引き続きサポートされます。

新しいジャーニーモデルには 1 つの制限があります。制限は次のとおりです **レガシーモデルから新しいモデルにアクティビティをコピーして貼り付けることはできません。逆も同様です**. これを行う場合は、ジャーニーをレガシーモデルで複製し、新しいモデルに切り替えてから、アクティビティをコピーすることをお勧めします。
