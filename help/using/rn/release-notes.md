...
<tr>
<td>
<p>ジャーニーライフサイクルイベントとカスタムアクションのパフォーマンスの監視と追跡に役立つ、3 つの新しいジャーニーアラートが使用できるようになりました。</p>
<ul>
<li><strong> 公開済みジャーニー</strong>: ジャーニーキャンバスで実務担当者がジャーニーを公開すると、通知を受け取ります。</li>
<li><strong>ジャーニー完了 </strong>: ジャーニーのタイプ （オーディエンスまたはイベントトリガーの読み取り）に基づく具体的な定義を使用して、ジャーニーの完了時にアラートを取得します。</li>
<li><strong> カスタムアクションキャッピングトリガー </strong>：カスタムアクションエンドポイントでキャッピングがアクティブ化されたときに通知されます。</li>
</ul>
<p>これらのアラートは、組織レベルまたは特定のジャーニーで購読できます。</p>
