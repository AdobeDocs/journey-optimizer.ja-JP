...
* 外部オーディエンス向けのジャーニーにおける&#x200B;**補足ID サポート** - ジャーニーの&#x200B;**補足ID**&#x200B;が、CSV ファイルから読み込まれたオーディエンスやFederated Audience Compositionで作成されたオーディエンスを含む&#x200B;**外部オーディエンス**&#x200B;でサポートされるようになりました。 オーディエンスからID以外の属性または個人ではないID属性を補足IDとして指定できます。スキーマのラベル付けは必要ありません。
