...
<thead>
<tr>
<th><strong>コンテンツバリエーションのシミュレート（一般提供）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
<p>一般提供リリースでは、この機能に多言語コンテンツとコンテンツ実験のサポートが含まれるようになり、様々な言語や処理でのバリエーションをテストできるようになりました。さらに、（プロファイル属性に加えて）コンテキスト属性もサポートされるようになり、より動的で状況に応じたコンテンツテストが可能になりました。</p>
...
<thead>
<tr>
<th><strong>ジャーニーでのコンテンツの決定</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>ジャーニーキャンバスの専用の決定アクションを使用してジャーニーにオファーを追加し、カスタムアクションで使用できるようになりました。</p>
</td>
</tr>
</tbody>
</table>
...
* **テンプレートおよびフラグメントのフォルダー（一般提供）**\
  以前は一連の組織（LA）に対して提供されていましたが、すべてのユーザー（GA）に対してコンテンツテンプレートとフラグメントを管理できるようになりました。フォルダーを使用すると、コンテンツテンプレートとフラグメントを構造化された階層に簡単かつ効果的に整理できます。
...
* **サンドボックスツール – 新しいキャンペーンオブジェクトのサポート（フェーズ 1）**\
