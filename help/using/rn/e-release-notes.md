...
- **[Beta] メールエディターのテーマに関する改善点**
  ...
  新しいベータ版機能では、メールエディターにテーマが導入されました。再利用可能なスタイルを定義し、事前設定済みのモジュールを使用してメールを迅速に作成できます。
...
- **AI モデル – ランキングの統一 – 新しい式ビルダー**
  ...
  新しい式ビルダーを使用して、Adobe Decisioning AI モデルのリアルタイムスコアを調整できるようになりました。 この機能は、優先度とモデルスコアのランキング調整を一元化します。
