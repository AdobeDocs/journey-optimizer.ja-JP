...
今後数日または数週間で、次のジャーニー機能が提供される予定です。 **以下の情報は変更される可能性があります。**
...
今後数日または数週間のうちに、次のオーケストレーションされたキャンペーン機能が予定されています。 **以下の情報は変更される可能性があります。**

<table>
<thead>
<tr>
<th><strong>オーケストレーションされたキャンペーンのファイルベースのターゲティング（限定提供）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
今後数日または数週間で、次のキャンペーンの改善が予定されています。 **以下の情報は変更される可能性があります。**
...
今後数日または数週間で、次の意思決定機能が提供される予定です。 **以下の情報は変更される可能性があります。**
...
今後数日または数週間で、次のメールチャネルの改善が予定されています。 **以下の情報は変更される可能性があります。**
...
今後数日または数週間で、次の管理上の改善が見込まれます。 **以下の情報は変更される可能性があります。**
...
今後数日または数週間で、次のレポートの改善が予定されています。 **以下の情報は変更される可能性があります。**
