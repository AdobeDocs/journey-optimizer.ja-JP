...
>[!NOTE]
>
>これらのリリースノートに記載されている機能には、各変更がいつ環境でアクセスできるようになったかを示す&#x200B;**利用可能日**&#x200B;が含まれています。 **近日公開予定**&#x200B;のエントリは、今後数日以内にリリースされる予定です。 情報は変更される場合があります。

## 26年5月のリリースノート {#may-26-rn}

### ジャーニー {#may-26-journeys}

このリリースでは、ジャーニーに次の機能と機能強化が追加されました。 追加の変更も今月に予定されています。以下の「[近日リリース予定](#may-26-journeys-coming-soon)」セクションを参照してください。
...
以下のジャーニー機能は、今月後半にリリース予定です。 情報は変更される場合があります。
...
このリリースでは、オーケストレーションされたキャンペーンに次の機能と機能強化が追加されました。 追加の変更も今月に予定されています。以下の「[近日リリース予定](#may-26-oc-coming-soon)」セクションを参照してください。
...
次のオーケストレーションされたキャンペーン機能は、今月後半にリリース予定です。 情報は変更される場合があります。
...
以下のキャンペーンの改善は、今月後半にリリースされる予定です。以下の「[近日公開](#may-26-campaigns-coming-soon)」セクションを参照してください。

#### 近日リリース予定 {#may-26-campaigns-coming-soon}

以下のキャンペーンの機能強化は、今月後半にリリース予定です。 情報は変更される場合があります。
...
このリリースでは、次の機能と機能強化がDecisioningに追加されました。 追加の変更も今月に予定されています。以下の「[近日リリース予定](#may-26-decisioning-coming-soon)」セクションを参照してください。
...
次の決定機能は、今月後半にリリース予定です。 情報は変更される場合があります。
...
このリリースでは、メールチャネルに次の機能と機能強化が追加されました。 追加の変更も今月に予定されています。以下の「[近日リリース予定](#may-26-email-coming-soon)」セクションを参照してください。
...
次のメールチャネルの機能強化は、今月後半にリリース予定です。 情報は変更される場合があります。
...
以下の管理機能の改善は、今月後半にリリースされる予定です。以下の「[近日リリース予定](#may-26-admin-coming-soon)」セクションを参照してください。

#### 近日リリース予定 {#may-26-admin-coming-soon}

以下の管理改善は、今月後半にリリース予定です。 情報は変更される場合があります。
