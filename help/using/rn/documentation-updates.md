...
* オーケストレートキャンペーンに関するよくある質問のページがリリースされました。 [詳細情報](../orchestrated/orchestrated-campaigns-faq.md)

* ジャーニーステップイベントのドキュメントに、最も頻繁に発生する廃棄 eventTypes の定義、一般的な原因およびトラブルシューティング手順が記載されたトラブルシューティングの節が追加されました。 [詳細情報](../reports/sharing-field-list.md#troubleshoot-discarded-event-types-in-journey_step_events)
...
* 一時停止中のジャーニーで破棄されたプロファイルについて理解するために、トラブルシューティングの節が追加されました。 [詳細情報](../building-journeys/journey-pause.md#troubleshoot-profile-discards-in-paused-journeys)
