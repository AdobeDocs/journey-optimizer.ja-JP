...
* 次世代の意思決定管理フレームワークと確立された意思決定管理ソリューションの違い、およびパーソナライズされたオファーを様々なチャネルで提供する主なメリットなど、Journey Optimizerの意思決定機能を説明する新しいページが追加されました。 [詳細情報](../experience-decisioning/gs-decision.md)
