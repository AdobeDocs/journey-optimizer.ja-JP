...
* コンテンツ最適化に関するドキュメントが再構成され、わかりやすくなりました。 メインの最適化ページは、開始ページ、ターゲティング専用のページ、実験用のページ、両方のアプローチを組み合わせるためのページの 4 つの焦点を絞ったサブページに分割されています。 [詳細情報](../content-management/gs-message-optimization.md)
