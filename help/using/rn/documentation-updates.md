...
* コードベースの実装サンプルのドキュメントが更新され、Decisioning で正確なトラッキングとアトリビューションをおこなうために、propositionAction のトークンフィールドが含まれるようになりました。 [詳細情報](../code-based/code-based-implementation-samples.md)
