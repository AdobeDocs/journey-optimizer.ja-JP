...
**このページでは、**&#x200B;既にAdobeにデリゲートされているサブドメインを使用するか、新しいサブドメインを設定してweb エクスペリエンス用のアセットコンテンツを公開することで、Adobe Journey Optimizerでweb サブドメインを設定する方法について説明します。
...
* Web サブドメインにアクセスして編集するには、本番稼働用サンドボックスで **[!UICONTROL Web サブドメインの管理]**&#x200B;権限が必要です。

* Web サブドメインへの変更は、本番稼働用サンドボックスにも影響します。
