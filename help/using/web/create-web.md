...
1. 「**[!UICONTROL コンテンツを編集]**」ボタンを選択し、web デザイナーを使用して、必要に応じてコンテンツを編集します。[詳細情報](edit-web-content.md)
...
1. 「**[!UICONTROL コンテンツを編集]**」ボタンをクリックして、web デザイナーでコンテンツを編集します。[詳細情報](edit-web-content.md)
