...
一度 [web エクスペリエンスを作成しました](edit-web-content.md) web デザイナーを使用すると、テストプロファイルを使用して、変更された web ページをプレビューできます。 パーソナライズされたコンテンツを挿入した場合は、テストプロファイルデータを使用して、このコンテンツがどのように表示されるかを確認できます。

これをおこなうには、 **[!UICONTROL コンテンツをシミュレート]** web キャンペーンのコンテンツ編集画面または web デザイナーから、テストプロファイルを追加し、テストプロファイルデータを使用して web ページを確認します。
