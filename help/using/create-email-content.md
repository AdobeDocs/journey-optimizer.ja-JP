...
[メッセージ](create-message.md)を作成したら、メールコンテンツの作成に取り掛かることができます。

1. 新しく作成したメッセージから、「**[!UICONTROL コンテンツを編集]**」セクションの「**[!UICONTROL E メールデザイナー]**」を選択します。

   ![](assets/import-html_1.png)

1. E メールデザイナーホームページで、次のオプションからメールのデザイン方法を選択します。

   * 「**[!UICONTROL ゼロからデザイン]**」を選択し、E メールデザイナー機能を使用してメールコンテンツを作成します。
...
1. 「**[!UICONTROL プレビュー]**」をクリックして、メールのレンダリングを確認します。デスクトップまたはモバイル表示を選択できます。
...
青い線は、構造コンポーネントをドロップする前の、構造コンポーネントの正確な位置を具体化しています。他のどのコンポーネントの上、間、下にドロップしても構いませんが、コンポーネント内にはドロップできません。
...
1. 1 列以上で構成される、複数の構造コンポーネントを使用できます。
...
構造を定義すると、コンテンツのフラグメントやコンポーネントをメールに追加できます。
...
「**[!UICONTROL プリヘッダー]**」編集ボックスを選択し、コンテンツを追加します。
...
3 列で構成される構造コンポーネント内で、パディングと垂直方向の整列を調整する場合。これをおこなうには、以下の手順に従います。
...
1. **コンテキストツールバー**&#x200B;から、「**[!UICONTROL 列を選択]**」をクリックし、編集する列を選択します。構造ツリーから選択することもできます。
   ...
   その列の編集可能なパラメーターは、右側の「**[!UICONTROL 設定]**」ウィンドウに表示されます。

1. 「**[!UICONTROL 垂直方向の整列]**」で、「**[!UICONTROL 上]**」を選択します。
...
1. コンポーネント設定で「**[!UICONTROL リンクに下線を引く]**」にチェックを入れると、リンクのラベルテキストに下線を引くことができます。

1. リンクを開く閲覧コンテキストを選択するには、「**[!UICONTROL ターゲット]**」を選択します。
