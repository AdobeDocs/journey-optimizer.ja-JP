...
**このページ：**&#x200B;ライブアクティビティで iPhone のロック画面と Dynamic Island に永続的なリアルタイムアップデートを配信する方法について説明します。これにより、進行中のイベントでユーザーのエンゲージメントを維持し、Adobe Journey Optimizer を使用して送信するのに必要な設定と API トリガーキャンペーンを計画できます。
