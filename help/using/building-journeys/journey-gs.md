...
**終了日**&#x200B;も追加できます。これにより、日付に達したプロファイルは自動的に終了します。 終了日が指定されていない場合、プロファイルは [グローバルジャーニータイムアウト](#global_timeout) （通常は 30 日間で、ヘルスケアシールドのアドオン機能を使用して 7 日間に短縮されます）。 唯一の例外は、「**繰り返し時に再エントリを強制する**」が有効になっている繰り返しの「オーディエンスを読み取り」ジャーニーで、これは次回の実行の開始日に終了します。
...
このグローバルタイムアウトにより、ジャーニーの個人の進行が停止します **30 日** 彼らが入ってきた後 このタイムアウトは、 **7 日** Healthcare Shield のアドオン機能を備えています。 つまり、個人のジャーニーは 30 日（7 日）を超えることはできません。 このタイムアウト期間が過ぎると、個人のデータは削除されます。 タイムアウト期間が終了してもまだジャーニーに流入してくる個人がいる場合、それらは流入を停止され、レポートでは考慮されません。したがって、離脱する人物よりもジャーニーにエントリする人物の方が多くなる可能性があります。
