...
>[!NOTE]
>
>ジャーニーは、プライバシーのオプトアウト、アクセス、削除などのリクエストに対して直接反応しません。ただし、グローバルタイムアウトにより、個人がどのジャーニーでも 30 日以上滞在することはなくなります。
...
ジャーニーでは、ジャーニー全体を通じて使用される結合ポリシーを遵守します。

>[!NOTE]
>
>この機能は、一部のお客様に対して限定提供（LA）でのみご利用いただけます。

結合ポリシーについて詳しくは、この[ページ](https://experienceleague.adobe.com/ja/docs/experience-platform/profile/merge-policies/overview)を参照してください。
