...
### 主要指標およびジャーニーのリスト {#access-metrics}
...
* ジャーニーを、次のステータス、タイプ、バージョンおよび割り当てられたタグに従ってフィルタリングします。 **[!UICONTROL ステータスとバージョンのフィルター]**.

  タイプは、**[!UICONTROL 単一イベント]**、**[!UICONTROL オーディエンスの選定]**、**[!UICONTROL オーディエンスを読み取り]**、**[!UICONTROL ビジネスイベント]**、**[!UICONTROL バースト]**&#x200B;のいずれかになります。

* 以下を使用します。 **[!UICONTROL 作成フィルター]** を使用して、ジャーニーを作成日またはジャーニーを作成したユーザーに応じてフィルタリングできます。

* 次の特定のイベント、フィールドグループまたはアクションを使用するジャーニーを表示： **[!UICONTROL アクティビティフィルター]** および **[!UICONTROL データフィルター]**.

* 以下を使用します。 **[!UICONTROL 公開フィルター]** をクリックして、公開日またはユーザーを選択します。 例えば、昨日公開されたライブジャーニーの最新バージョンを表示するように選択できます。

  <!--To filter journeys based on a specific date range, select **[!UICONTROL Custom]** from the **[!UICONTROL Published]** drop-down list.-->

さらに、イベント、データソース、アクションの設定ペインで、 **[!UICONTROL 使用場所]** 「 」フィールドには、特定のイベント、フィールドグループまたはアクションを使用するジャーニーの数が表示されます。 「**[!UICONTROL ジャーニーを表示]**」ボタンをクリックすると、対応するジャーニーのリストを表示できます。
