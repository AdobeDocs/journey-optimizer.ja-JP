...
ジャーニーをアクティブ化し、新しいプロファイルが入力できるようにするには、ジャーニーを公開する必要があります。ジャーニーを公開する前に、そのジャーニーが有効で、エラーがないことを確認します。エラーのあるジャーニーは公開できません。Journey Optimizerでは、保存時と公開時にペイロードサイズを検証して、安定性とパフォーマンスを維持することもできます。 ジャーニーの公開について詳しくは、この [&#x200B; 節 &#x200B;](publish-journey.md) と [&#x200B; ジャーニーペイロードサイズの検証 &#x200B;](../start/guardrails.md#journey-payload-size) を参照してください。
