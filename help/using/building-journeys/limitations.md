...
* 送信スロットルに制限はありません。 
* エラーが発生した場合、3回の再試行が体系的に実行されます。 受け取ったエラーメッセージに応じて、再試行の回数を調整することはできません。 
...
* v1のイベントアクティビティで始まるジャーニーは、それ以降のバージョンのイベント以外で始まることはできません。 **セグメントの選定**&#x200B;イベントでジャーニーを開始することはできません。
...
* **セグメントの読み取り**で始まるジャーニーは、次のバージョンの別のイベントで始まることはできません。
 
