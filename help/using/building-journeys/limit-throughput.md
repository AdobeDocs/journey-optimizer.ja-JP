...
外部データソースやカスタムアクションを扱う場合は、ジャーニーのスループットを制限して、外部システムを保護する必要が生じる場合があります。単一のジャーニーの場合は最大 5,000 インスタンス/秒、オーディエンストリガーの場合は最大 20,000 インスタンス/秒です。
...
例として、**オーディエンストリガージャーニー** 10,000 件 **のプロファイルの母集団との連携** 1 秒あたり 100 件のリクエスト **をサポートする外部システムへのデータ送信** を見てみましょう。
