...
この節では、オーディエンスの閲覧、イベント、反応イベント、電子メール/プッシュメッセージを組み合わせた使用例を示します。

![](assets/jo-uc1.png)

## ユースケースの説明

この使用例では、特定のオーディエンスに属するすべての顧客に最初のメッセージ（E メールとプッシュ）を送信します。
...
* 1980 年以降に生まれた、アトランタ、サンフランシスコまたはシアトルに住むすべての顧客のオーディエンス。
* 購入イベント

### オーディエンスの作成

ジャーニーでは、特定の顧客オーディエンスを活用したいと考えています。 オーディエンスに属するすべての個人がジャーニーにエントリし、異なる手順に従います。 この例では、アトランタ、サンフランシスコまたはシアトルに住み、1980 年以降に生まれたすべての顧客をターゲットにするオーディエンスが必要です。

オーディエンスについて詳しくは、 [ページ](../audience/about-audiences.md).

1. 「お客様」メニュー・セクションで、 **[!UICONTROL オーディエンス]**.

1. 次をクリック： **[!UICONTROL オーディエンスを作成]** ボタンをクリックします。

1. 内 **[!UICONTROL オーディエンスのプロパティ]** ウィンドウで、オーディエンスの名前を入力します。
...
オーディエンスが作成され、ジャーニーで使用できる状態になりました。 の使用 **オーディエンスの閲覧** アクティビティを使用すると、オーディエンスに属するすべての個人をジャーニーにエントリさせることができます。
...
1. ジャーニーを開始するには、 **オーディエンスの閲覧** アクティビティ。 前に作成したオーディエンスを選択します。 オーディエンスに属するすべての個人がジャーニーにエントリします。
...
1. 最初のパスに&#x200B;**反応**&#x200B;イベントを追加し、「**プッシュの開封**」を選択します。イベントは、オーディエンスに属する個人が最初のメッセージのプッシュバージョンを開いたときにトリガーされます。
