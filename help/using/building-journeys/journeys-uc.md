...
![&#x200B; オーディエンスを読み取り、待機およびメール アクティビティを使用したシンプルなジャーニーフロー &#x200B;](assets/jo-uc1.png)
...
1. 「**[!UICONTROL 保存]**」をクリックします。
   ...
   ![&#x200B; エンリッチメントデータを選択するための追加属性パネル &#x200B;](assets/add-attributes.png)
...
1. 「**[!UICONTROL 保存]**」をクリックします。
   ...
   ![&#x200B; 条件アクティビティがゴールド メンバーおよび他のパスに分岐しているジャーニー](assets/jo-uc2.png)
...
1. ジャーニーを&#x200B;**オーディエンスを読み取り**&#x200B;アクティビティで開始します。前に作成したオーディエンスを選択します。そのオーディエンスに属するすべての個人がジャーニーにエントリします。
   ...
   ![&#x200B; 気温 50 度以下の場合の気象状態の確認 &#x200B;](assets/jo-uc4.png)
...
1. **メール**&#x200B;アクションアクティビティをドロップし、「最初のメッセージ」のコンテンツを定義します。ジャーニー内のすべての個人にこのメッセージが送信されます。メールを設定およびデザインする方法については、この[節](../email/create-email.md)を参照してください。
   ...
   ![&#x200B; 温度条件とメールアクションを備えた天気ベースのジャーニーを完了 &#x200B;](assets/jo-uc5.png)
