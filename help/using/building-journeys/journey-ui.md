...
* **ドラフト（テスト）**:「**テストモード**」ボタンを使用して、テストモードがアクティブになりました。 [詳細情報](../building-journeys/testing-the-journey.md)
...
* **ライブ**：ジャーニーは「**公開** ボタンを使用して公開されました。 [詳細情報](../building-journeys/publishing-the-journey.md)
* **一時停止**:「一時停止 **ボタンを使用して、ライブジャーニーが一時停止され** した。 [詳細情報](../building-journeys/journey-pause.md)
* **停止済み**：「**停止**」ボタンを使用してジャーニーがオフになっています。すべての個人が即座にジャーニーから退出します。 [詳細情報](../building-journeys/end-journey.md#stop-a-journey)
...
>[!NOTE]
>
>* ジャーニーオーサリングライフサイクルには、フィルタリングできない一連の中間ステータスも含まれます。**公開** （「ドラフト」と「ライブ」の間）、**テストモードのアクティブ化** または **テストモードの非アクティブ化** （**ドラフト** と **ドラフト （テスト）** の間）、**停止** （**ライブ** と **停止** の間）、**再開** （**一時停止** と **&#x200B;**&#x200B;**&#x200B;** **&#x200B;**&#x200B;**&#x200B;** Live の間） ジャーニーは中間状態にあり、読み取り専用です。
>
>* **ライブ** ジャーニーを変更する必要がある場合は、ジャーニーの [ 新しいバージョンを作成 ](#journey-versions) します。 また、ライブジャーニーを一時停止し、必要なすべての変更を実行して、いつでも再開できます。 [ ジャーニーの一時停止の詳細情報 ](../building-journeys/journey-pause.md)
