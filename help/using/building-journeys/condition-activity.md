...
>abstract="シンプルな式エディターモードでは、フィールドの組み合わせに基づいてシンプルなクエリを実行できます。 使用可能なすべてのフィールドが画面の左側に表示されます。 フィールドはメインゾーンにドラッグ&amp;ドロップされます。 異なる要素を組み合わせるために、異なるグループやグループレベルを作成するために、互いに連結されます。 論理演算子は、同じレベルの要素を結合します。"
