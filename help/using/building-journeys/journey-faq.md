...
はい。ジャーニーイベントまたは条件に基づいて&#x200B;**のプロファイル属性を変更するには、** プロファイルの更新[!DNL Adobe Experience Platform] アクティビティを使用します。 これは、ロイヤルティポイントの更新、ジャーニーマイルストーンの記録、環境設定の変更、顧客エンゲージメントスコアのトラッキングに役立ちます。
...
詳しくは、[条件](conditions.md)、[メッセージアクション](journeys-message.md)、[チャネルの選択](../channels/gs-channels.md)を参照してください。
...
* 可能であれば、外部呼び出しではなく[!DNL Adobe Experience Platform] データセット検索[を使用して、](dataset-lookup.md)に頻繁に使用されるデータを保存します
