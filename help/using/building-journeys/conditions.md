...
>title="条件"
>abstract="条件を使用すると、特定の条件に基づいて複数のパスを作成することで、個人がジャーニーをどのように進めるかを定義できます。 また、タイムアウトやエラーを処理するための代替パスを設定して、シームレスなエクスペリエンスを確保することもできます。 条件が最適化アクティビティで設定され、以前の条件アクティビティが置き換えられることに注意してください。"
