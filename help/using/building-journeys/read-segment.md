...
例として、 [セグメントの構築ユースケース](../segment/about-segments.md). を使用 **[!UICONTROL セグメントを読み取り]** アクティビティを使用すると、セグメントに属するすべての個人をジャーニーにエントリさせ、すべてのジャーニー機能を利用する個別のジャーニーにフローさせることができます。条件、タイマー、イベント、アクション。
