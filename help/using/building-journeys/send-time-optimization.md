...
![ メールチャネル設定の送信時間の最適化切り替え ](assets/jo-message5.png)
...
![ 電子メールの最適な送信時間を日および時間別に示すエンゲージメントヒートマップ ](assets/heatmap-1.png)

上記の予測確率を持つユーザーが、送信時間の最適化をオンに切り替えて最大待機時間を 7 時間に設定し、水曜日の午前 9 時にメッセージを送信する場合、メッセージの送信時間は午後 12 時になります。

![ 詳細な時間別最適化データを使用したエンゲージメントヒートマップ ](assets/heatmap-2.png)
