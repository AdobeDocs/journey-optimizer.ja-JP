...
[!DNL Adobe Journey Optimizer] の送信時間最適化機能は、AdobeのジャーニーAI サービスを活用して、メールおよびプッシュメッセージの最適な送信時間を選択し、顧客の過去のオープンおよびクリック行動に基づいて、顧客エンゲージメントを最大限に高めます。
...
>[!AVAILABILITY]
>
>* お客様のリクエストに応じて、送信時間の最適化機能 [!DNL Adobe Journey Optimizer] 有効になります。 組織でこの機能を有効にするには、アドビカスタマーケアまたはアドビ担当者にお問い合わせください。
>
...
![メールチャネル設定の送信時間の最適化の切替スイッチ](assets/jo-message5.png)
...
送信時間最適化モデルは、組織の最 [!DNL Adobe Journey Optimizer] の顧客行動データを取り込み、ユーザーレベルの開始イベントとクリックイベントを調べて、顧客がメッセージングに関与する可能性が最も高いタイミングを判断します。
