...
**アクション** アクティビティは、ジャーニーキャンバス内のすべてのチャネルアクションの単一のエントリポイントです。 これは、以前の個々のビルトインチャネルアクティビティに代わって、メール、プッシュ、SMS、アプリ内、web、コードベースのエクスペリエンス、コンテンツカードを1つの統合アクティビティタイプに統合します。
