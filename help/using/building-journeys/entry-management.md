...
* 繰り返しジャーニーの場合：オーディエンスの期待されるステータスにある場合、プロファイルは、繰り返しごとにジャーニーに入ります。 プロファイルが以前の繰り返し時からジャーニーにまだ留まっていた場合は、ジャーニーを最初からやり直します。

ビジネスイベントジャーニーで、 **オーディエンスの閲覧** アクティビティ：このジャーニーがビジネスイベントの受信に基づいていることを理解し、期待されるオーディエンスでプロファイルが絞り込まれると、受信した各ビジネスイベントのジャーニーに入ります。つまり、このプロファイルは同じジャーニーで複数回同時に使用できます。
