...
# ジャーニーのシミュレート{#testing_the_journey}
...
1. 「![ イベントを編集](assets/do-not-localize/Smock_Edit_18_N.svg)」をクリックして、このシミュレートされたユーザーのイベントを調整します。

   ![イベント選択のフィールドとドロップダウンを含むイベント設定インターフェイス](assets/simulate-9.png)

1. シミュレートされたユーザーのドロップダウンから、シミュレートされたユーザーを選択し、イベントとその生成方法の設定を完了します。

   ![イベント選択のフィールドとドロップダウンを含むイベント設定インターフェイス](assets/simulate-8.png)

1. 「**[!UICONTROL 選択したイベントをトリガー]**」をクリックします。
...
| イベントの事前入力（ブラウザーのみ） | — | イベントの事前入力は、ブラウザーでのみサポートされています。 事前入力されたイベントデータは、ブラウザーに固有のものです。 |
