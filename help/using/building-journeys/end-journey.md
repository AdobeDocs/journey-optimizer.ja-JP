...
**非繰り返しオーディエンスジャーニー**&#x200B;は、最後のプロファイルがジャーニーを終了すると、自動的に&#x200B;**[!UICONTROL 停止]** ステータスに移行するようになりました。 これにより、プロファイルがアクティブに流れていなかったにもかかわらず、91日間のグローバルタイムアウトが期限切れになるまで、繰り返し繰り返されないオーディエンス読み取りジャーニーが&#x200B;**ライブ**&#x200B;状態のままだった以前の動作が削除されます。
...
>[!NOTE]
>
>繰り返し発生しないオーディエンス読み取りジャーニーは、**[!UICONTROL 新しいエントリに近づく]** オプションを使用して、いつでも手動で閉じることができます。 自動停止動作により、手動での介入なしに、ジャーニーが不要になったときに自動的に停止されます。
