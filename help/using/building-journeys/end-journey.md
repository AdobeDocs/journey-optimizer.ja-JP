...
* 1回限りの「オーディエンスを読み込む」ジャーニーは、実行後もライブステータスのままになります。このジャーニーは手動で閉じるか、91日後に閉じる必要があります。
...
* **Q: オーディエンスジャーニーの「読み取り」が「完了」ステータスに達するのはいつですか？**  – 実行開始後91日（非繰り返し）、終了日に達した場合（終了日で繰り返し）、または開始後91日（終了日なしで繰り返し）。
