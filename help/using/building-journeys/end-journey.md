...
30 日後、「オーディエンスを読み取り」ジャーニーは&#x200B;**完了済み**&#x200B;ステータスに切り替わります。ジャーニーにエントリしたプロファイルに関するすべての情報は、ジャーニーにエントリしてから 30 日後に削除されるので、この動作は 30 日間にのみ設定されます（つまり、ジャーニーのタイムアウトのデフォルト値）。ジャーニーにまだ留まっているユーザーは、自動的に影響を受けます。30 日間のタイムアウトが経過すると、ジャーニーは終了します。
