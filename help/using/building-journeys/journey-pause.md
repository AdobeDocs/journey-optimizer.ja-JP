...
>title="ジャーニーの一時停止"
>abstract="ライブジャーニーを一時停止すると、新しいプロファイルのエントリが防がれます。 ジャーニー内の現在のプロファイルは、破棄するか、そのまま保持できます。 保持した場合は、ジャーニーを再開すると、次のアクションアクティビティで実行が再開されます。 進行状況を失うことなく、更新や緊急停止するのに最適です。"
...
>title="ジャーニーの再開"
>abstract="一時停止したジャーニーを再開すると、新しいプロファイルが再度エントリできます。 プロファイルが一時停止中に待機していた場合、ジャーニーは続行されます。 更新または一時停止後にジャーニーを安全に再開するのに最適です。"
