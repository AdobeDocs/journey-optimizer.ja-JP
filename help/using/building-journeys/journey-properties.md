...
description: ' [!DNL Adobe Journey Optimizer] を使用してジャーニーのプロパティを設定する方法を説明します。'
...
* 統合タグ [!DNL Adobe Experience Platform] ジャーニーに割り当てると、それらを簡単に分類し、キャンペーンリストからの検索を改善できます。 [タグの操作方法について詳しくは、こちらを参照してください](../start/search-filter-categorize.md#tags)。
...
タイムゾーンはジャーニーレベルで定義されます。固定タイムゾーンを入力するか、プロファイル [!DNL Adobe Experience Platform] 使用してジャーニータイムゾーンを定義できます。 プロファイルでタイムゾーン [!DNL Adobe Experience Platform] 定義されている場合は、ジャーニーでそのタイムゾーンを取得できます。
...
タイムアウト設定は、ジャーニーがアクティビティの実行を待つ時間と、プロファイルがジャーニーに残ることができる時間を制御します。
...
2024 年 6[!DNL Adobe Journey Optimizer] リリースより、ジャーニーのグローバルタイムアウトは 30 日から 91 日に変更されました。 影響について詳しくは、以下の FAQ を参照してください。
