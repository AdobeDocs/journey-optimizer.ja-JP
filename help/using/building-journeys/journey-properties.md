...
<table style="table-layout:auto">
  ...
  <tr style="border: 1;">
    ...
    <td>
      <p>プロファイルは、元のジャーニーバージョンの公開時間に合わせて、30日（HIPAAの場合は7日）のTTLを維持します。 強制的な再エントリを伴う、繰り返しジャーニーの場合、TTL は繰り返し期間と一致します。</p>
    </td>
  </tr>
  <tr style="border: 1;">
    <td>
...
複数の出口条件を追加できます。 出口基準がアクティブになり、ジャーニーの各ステップで評価されます。
