...
>title="ジャーニーのプロパティ"
>abstract="名前、タグ、エントランス ルール、タイムゾーン、日付、タイムアウト、競合管理など、このジャーニーのグローバル設定を構成します。 読み取り専用パラメーターは、デフォルトでは非表示になっています。 利用できるオプションは、ジャーニーのステータス、権限、製品設定によって異なります。"
...
>abstract="設定された制限と比較したジャーニーペイロードの現在のサイズを表示します。 このインジケーターは、公開前にジャーニーの複雑さを監視し、ペイロードサイズの制限を超えることに起因するエラーを回避するために使用します。"
...
>title="結合ポリシー"
>abstract="結合ポリシーは、選択したイベントまたはオーディエンスに基づいて自動的に取得されます。 この結合ポリシーは、ジャーニー全体で使用されます。"
