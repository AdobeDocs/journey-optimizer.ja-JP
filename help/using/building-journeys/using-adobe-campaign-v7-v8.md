...
title: '[!DNL Adobe Campaign] v7/v8 のアクション'
description: v7/v8 のアクショ  [!DNL Adobe Campaign]  について説明します
...
>title="カスタムアクション"
>abstract="[!DNL Adobe Campaign] v7 または v8 がある場合は、統合を使用できます。 トランザクションメッセージ機能を使用して、メール、プッシュ通知、SMS[!DNL Adobe Campaign] 送信できます。"

[!DNL Adobe Campaign] v7 または v8 がある場合は、統合を使用できます。 トランザクションメッセージ機能を使用して、メール、プッシュ通知、SMS[!DNL Adobe Campaign] 送信できます。
