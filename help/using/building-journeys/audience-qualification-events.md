...
### セグメントメンバーシップの更新のタイミング {#timing-segment-membership}

ジャーニーでバッチスナップショットを使用する場合、新しいセグメントメンバーシップは後続のスナップショットにのみ反映されます。 即時または当日のセグメント追加が不可欠な場合は、ストリーミングセグメント化を検討するか、セグメントの更新が次のスナップショットによって取り込まれていることを確認します。
