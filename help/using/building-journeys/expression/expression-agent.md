...
>id="journeyExpAI"
>title="式アシスタントを使用した式の生成"
>abstract="式アシスタントは、生成 AI を使用して、ユーザーがジャーニーの高度な式エディターで式を直接作成および生成できるよう支援します。 条件の例として、**最適化**&#x200B;アクティビティ、またはカスタム日付を使用する&#x200B;**待機**&#x200B;アクティビティなどがあります。 必要なものを平易な言葉で説明すると、アシスタントがそれに応じた式を生成します。"
