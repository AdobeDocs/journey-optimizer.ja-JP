...
1. **接触チャネルジャーニー**&#x200B;を設計します。
   ...
   ![&#x200B; ジャーニー間の移行のためのジャーニーパレット内のジャンプアクティビティ &#x200B;](assets/jump1.png)
...
1. 次のアクティビティを追加し、接触チャネルジャーニーを終了します。
   ...
   ![&#x200B; ジャーニー間のジャンプアクティビティをテストするためのテストモードインターフェイス &#x200B;](assets/jump5.png)
...
![&#x200B; ジャンプ アクティビティの実行指標を示すジャーニー分析 &#x200B;](assets/jump6.png)
