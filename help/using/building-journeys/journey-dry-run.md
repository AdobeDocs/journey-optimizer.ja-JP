...
>abstract="ジャーニードライランは、ジャーニー実務担当者が実際の実稼動データを使用してジャーニーをテストできる、[!DNL Adobe Journey Optimizer] の特別なジャーニー公開モードです。 ジャーニーを設計したら、ドライランを実行して、ジャーニーが機能し、手順が正しいことを確認します。この公開モードを使用すると、通信をプロファイルに送信せずに、ジャーニーをスモークテストできます。"
