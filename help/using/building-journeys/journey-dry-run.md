...
>abstract="ジャーニーのドライランは、[!DNL Adobe Journey Optimizer] の特別なジャーニー公開モードです。このモードでは、ジャーニーの実務担当者は、実際の本番データを使用してジャーニーをテストできます。 ジャーニーを設計すると、ドライランによってジャーニーが機能することを確認し、手順が正しいことを確認します。 この公開モードを使用すると、通信をプロファイルに送信せずに、ジャーニーをスモークテストできます。"
...
* ドライランのジャーニーは、14日後に自動的にドラフトに戻ります
...
* 混同しないでください：「ドライラン」≠「テストモード」 – ドライランは実際の実稼動データを使用し、クォータにカウントします。テストモードは合成テストプロファイルを使用し、使用しません
