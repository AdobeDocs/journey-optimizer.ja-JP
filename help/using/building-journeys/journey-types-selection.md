...
| **データ要件** | トリガーデータを含むイベントスキーマ | [!DNL Adobe Experience Platform]人のオーディエンス | ストリーミングオーディエンスが必要です。 2026年8月から廃止されたバッチオーディエンス — [今すぐ移行](aq-batch-audiences-migration.md) | ビジネスイベントスキーマ |
