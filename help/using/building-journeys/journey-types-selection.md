...
| 目標 | 推奨ジャーニータイプ | 理由 |
|-----------|--------------------------|-----|
| 購入後に注文確認を送信 | 単一イベント | 個々のアクションに対する即座の応答 |
...
| **例** | 注文確認、パスワードリセット | 毎月のニュースレター、季節のキャンペーン | VIPのアップグレード、解約リスクに関する警告 | 低在庫アラート、Flash セール、価格低下 |
...
* **Q：購入後に注文確認を処理するジャーニータイプはどれですか？**  – 単一のイベントジャーニーを使用します。個々の顧客のアクションに即座にリアルタイムの応答を提供します。
