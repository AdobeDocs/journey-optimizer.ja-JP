...
**このページ：**&#x200B;ランディングページでは、メール、広告、キャンペーンからのクリックを、顧客がオプトインまたはオプトアウトし、環境設定を管理し、プロファイルデータを共有する専用の web 宛先に変換します。これにより、同意したオーディエンスを拡大し、パーソナライゼーションを強化するファーストパーティデータを収集できます。
