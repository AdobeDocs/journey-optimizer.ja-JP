...
**このページ：**&#x200B;のランディングページでは、電子メール、広告、キャンペーンのクリックを専用のweb宛先に変換します。顧客は、オプトインまたはオプトアウト、環境設定の管理、プロファイルデータの共有を行います。これにより、同意したオーディエンスを増やし、パーソナライゼーションを強化するファーストパーティデータを収集できます。
