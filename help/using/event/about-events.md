...
**このページ：** イベントは、ジャーニーを開始するリアルタイム トリガーです。単一、ビジネス、オーディエンスの選定タイプを比較して、各ユースケースに適したタイプを選択してください。
...
| **一般的なユースケース** | カート放棄の回復、フォーム送信、アプリログイン、ロイヤルティマイルストーン。 | フライトキャンセル、在庫補充アラート、速報、天気イベント。 |
